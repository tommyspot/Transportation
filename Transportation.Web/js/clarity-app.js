...
var clarityApp = angular.module('clarityApp', ['ngCookies', 'ngRoute', 'ui.bootstrap', 'ui.select2', 'ui.sortable', 'datepicker'], function ($routeProvider, $httpProvider) {
    ...
    .when('/ql-toa-hang/don-hang-cua-khach', {
    	templateUrl: '/html/toahang/don-hang-cua-khach.html' + '?v=' + VERSION_NUMBER,
    	controller: 'CustomerOrderManagementController',
    	access: 'authorized'
    })
        .when('/ql-toa-hang/don-hang-cua-khach/tao', {
        	templateUrl: '/html/toahang/don-hang-cua-khach-form.html' + '?v=' + VERSION_NUMBER,
        	controller: 'CustomerOrderManagementController',
        	access: 'authorized'
        })
        .when('/ql-toa-hang/don-hang-cua-khach/:customerOrder_id', {
        	templateUrl: '/html/toahang/don-hang-cua-khach-detail.html' + '?v=' + VERSION_NUMBER,
        	controller: 'CustomerOrderManagementController',
        	access: 'authorized'
        })
        .when('/ql-toa-hang/don-hang-cua-khach/sua/:customerOrder_id', {
        	templateUrl: '/html/toahang/don-hang-cua-khach-form.html' + '?v=' + VERSION_NUMBER,
        	controller: 'CustomerOrderManagementController',
        	access: 'authorized'
        })
				...
				if (nav !== '/') {
					...
					switch (nav) {
						...
						case '/ql-toa-hang/quyet-toan':
							...
							break;
						case '/ql-toa-hang/don-hang-cua-khach':
							breadCrumb.name = 'Đơn hàng của khách';
							break;
						case '/ql-garage':
