...
(function (Clarity) {
    ...
    (function (Service) {
        var TrashService = (function (_super) {
            ...
            TrashService.prototype.updateTrashRecord = function (entity, successCallback, errorCallback) {
                var _this = this;
                this.http.post('/api/trash/updateTrashRecord', { 'trashes': entity })
                    .success(function (data) { _this.doCallback(successCallback, data); })
                    .error(function () { _this.doCallback(errorCallback, null); });
            };
            TrashService.prototype.deleteTrashRecord = function (entity, successCallback, errorCallback) {
                var _this = this;
                this.http.post('/api/trash/deleteTrashRecord', { 'trashes': entity })
                    .success(function (data) { _this.doCallback(successCallback, data); })
                    .error(function () { _this.doCallback(errorCallback, null); });
            };
            TrashService.prototype.dropRecord = function (entity, successCallback, errorCallback) {
                var _this = this;
