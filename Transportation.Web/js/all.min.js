...
(function (Clarity) {
    var Model;
    (function (Model) {
        var WagonSetlementModel = (function (_super) {
            __extends(WagonSetlementModel, _super);
            function WagonSetlementModel() {
                _super.apply(this, arguments);
            }
            return WagonSetlementModel;
        }(Model.BaseModel));
        Model.WagonSetlementModel = WagonSetlementModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
    ...
    (function (Controller) {
        ...
        var WagonManagementController = (function () {
            ...
            WagonManagementController.prototype.createWagonSettlement = function (wagon) {
                ...
                var wagonSettlement = new Clarity.Model.WagonSetlementModel();
