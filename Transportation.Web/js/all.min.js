...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var ProductInputManagementController = (function () {
            function ProductInputManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            ProductInputManagementController.prototype.initProductInput = function () {
                ...
                if (productInputId) {
                    ...
                    if (this.$location.path() === '/ql-garage/nhap-kho/tao') {
                        this.currentProductInput = new Clarity.Model.ProductInputModel();
                    }
            ...
            ProductInputManagementController.prototype.removeProductInDetail = function (product) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa sản phẩm?');
                if (confirmDialog) {
                    this.productInputService.deleteEntity(product, function (data) {
            ...
            ProductInputManagementController.prototype.createProduct = function (product) {
                var _this = this;
                this.productInputService.create(product, function (data) {
                    _this.$location.path('/ql-garage/san-pham');
                }, null);
            };
            ProductInputManagementController.prototype.updateProduct = function (product) {
                var _this = this;
                this.productInputService.update(product, function (data) {
                    _this.$location.path('/ql-garage/san-pham');
                }, null);
            };
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var OrderManagementController = (function () {
            function OrderManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
