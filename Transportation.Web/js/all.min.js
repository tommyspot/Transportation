...
(function (Clarity) {
    ...
    (function (Helper) {
        var MainHelper = (function () {
            function MainHelper($http, $cookieStore) {
                this.$http = $http;
            ...
            MainHelper.prototype.formatCurrency = function (num) {
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var CustomerOrderModel = (function (_super) {
            __extends(CustomerOrderModel, _super);
            function CustomerOrderModel() {
                _super.apply(this, arguments);
            }
            return CustomerOrderModel;
        }(Model.BaseModel));
        Model.CustomerOrderModel = CustomerOrderModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Service;
    (function (Service) {
        var CustomerOrderService = (function (_super) {
            __extends(CustomerOrderService, _super);
            function CustomerOrderService($http) {
                _super.call(this, $http);
                this.url = '/api/customerOrders';
            }
            CustomerOrderService.prototype.getById = function (id, successCallback, errorCallback) {
                var _this = this;
                this.http({ method: 'GET', url: this.url + '/' + id })
                    .success(function (data) {
            ...
            CustomerOrderService.prototype.getAll = function (successCallback, errorCallback) {
                var _this = this;
                this.http.get(this.url)
                    .success(function (data) {
            ...
            CustomerOrderService.prototype.getCustomerOrdersByDate = function (dateObject, successCallback, errorCallback) {
                var _this = this;
        ...
        Service.CustomerOrderService = CustomerOrderService;
    })(Service = Clarity.Service || (Clarity.Service = {}));
})(Clarity || (Clarity = {}));
    ...
    (function (Controller) {
        ...
        var LogoutController = (function () {
            function LogoutController($scope, $location, $window, $rootScope, $http, $cookieStore) {
                ...
                $scope.viewModel = this;
                this.authenticationService = new service.AuthenticationService($http, $cookieStore);
                this.mainHelper = new Clarity.Helper.MainHelper($http, $cookieStore);
            }
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var MainController = (function () {
            ...
            MainController.prototype.goToCustomerOrderSection = function () {
        ...
        var EmployeeManagementController = (function () {
            ...
            EmployeeManagementController.prototype.initEmployeeList = function () {
                ...
                this.employeeService.getAll(function (results) {
                    ...
                    _this.employeeListTmp = _this.employeeList;
            ...
            EmployeeManagementController.prototype.changeDateFormat = function (date) {
                var formatedDate = '';
                if (date) {
            ...
            EmployeeManagementController.prototype.checkStatusEmployee = function (employee) {
        ...
        var TruckManagementController = (function () {
                ...
                if (truckId) {
                    if (this.$location.path() === '/ql-toa-hang/xe/' + truckId) {
                        this.truckService.getById(truckId, function (data) {
                            ...
                            _this.monthlyPaymentFormated = data.monthlyPayment.toLocaleString();
                        }, null);
                    }
            ...
            TruckManagementController.prototype.initTruckList = function () {
                ...
                this.truckService.getAll(function (results) {
                    ...
                    _this.truckListTmp = _this.truckList;
                    _this.initPagination();
                    _this.isLoading = false;
                }, null);
            };
            ...
            TruckManagementController.prototype.changeDateFormat = function (date) {
                var formatedDate = '';
                if (date) {
                    var newDate = new Date(date);
                    var dateNo = newDate.getDate().toString();
            ...
            TruckManagementController.prototype.checkStatusTruck = function (truck) {
                return truck.isDeleted ? 'Không' : 'Có';
            };
            TruckManagementController.prototype.getEmployeeName = function (id) {
            ...
            TruckManagementController.prototype.setCurrencyFormat = function (changeFormatNumber) {
                if (changeFormatNumber && changeFormatNumber != '') {
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var CustomerManagementController = (function () {
            function CustomerManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
                ...
                if (customerId) {
                    if (this.$location.path() === '/ql-toa-hang/khach-hang/' + customerId) {
                        this.customerService.getById(customerId, function (data) {
                            ...
                            _this.currentCustomer.totalOwnedFormated = _this.currentCustomer.totalOwned.toLocaleString();
                            _this.currentCustomer.totalPayFormated = _this.currentCustomer.totalPay.toLocaleString();
                            _this.currentCustomer.totalDebtFormated = _this.currentCustomer.totalDebt.toLocaleString();
                        }, null);
                    }
            ...
            CustomerManagementController.prototype.initCustomerList = function () {
                ...
                this.customerService.getAll(function (results) {
                    ...
                    _this.customerListTmp = _this.customerList;
                    _this.initPagination();
                    _this.isLoading = false;
                }, null);
            };
            ...
            CustomerManagementController.prototype.getEmployeeName = function (id) {
                if (this.employeeList) {
                    for (var i = 0; i < this.employeeList.length; i++) {
                        var employee = this.employeeList[i];
                        if (employee.id == id) {
            ...
            CustomerManagementController.prototype.setCurrencyFormat = function (changeFormatNumber, type) {
                if (changeFormatNumber && changeFormatNumber != '') {
                    switch (type) {
                        case '0':
...
(function (Clarity) {
    ...
    (function (Controller) {
        var service = Clarity.Service;
        var helper = Clarity.Helper;
        var CustomerOrderManagementController = (function () {
            function CustomerOrderManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            CustomerOrderManagementController.prototype.initEmployeeList = function () {
                var _this = this;
                this.employeeService.getAll(function (results) {
                    _this.employeeList = results;
                }, null);
            };
            CustomerOrderManagementController.prototype.initCustomerList = function () {
                var _this = this;
                this.customerService.getAll(function (results) {
                    _this.customerList = results;
                }, null);
            };
            CustomerOrderManagementController.prototype.initTruckList = function () {
                var _this = this;
                this.truckService.getAll(function (results) {
                    _this.truckList = results;
                }, null);
            };
            CustomerOrderManagementController.prototype.initCustomerOrder = function () {
                var _this = this;
                this.initCustomerList();
                this.initTruckList();
                ...
                if (customerOrderId) {
                    if (this.$location.path() === '/ql-toa-hang/don-hang-cua-khach/' + customerOrderId) {
                        this.customerOrderService.getById(customerOrderId, function (data) {
                            _this.currentCustomerOrder = data;
                            _this.unitPriceFormated = data.unitPrice != 0 ? data.unitPrice.toLocaleString() : '';
                        }, null);
                    }
                        ...
                        if (this.currentCustomerOrder == null) {
                            this.customerOrderService.getById(customerOrderId, function (data) {
                                _this.currentCustomerOrder = data;
                                _this.unitPriceFormated = data.unitPrice != 0 ? data.unitPrice.toLocaleString() : '';
                                _this.currentCustomerOrder.totalPayFormated = data.totalPay != 0 ? data.totalPay.toLocaleString() : '';
                            }, null);
                        }
                    }
                }
                    ...
                    if (this.$location.path() === '/ql-toa-hang/don-hang-cua-khach/tao') {
                        this.currentCustomerOrder = new Clarity.Model.CustomerOrderModel();
                    }
            ...
            CustomerOrderManagementController.prototype.initCustomerOrderList = function () {
                var _this = this;
                this.customerOrderService.getAll(function (results) {
                    _this.customerOrderList = results;
                    _this.customerOrderList.sort(function (a, b) {
                        return a.id - b.id;
                    });
                    _this.customerOrderListTmp = _this.customerOrderList;
                    _this.initPagination();
                    _this.isLoading = false;
                }, null);
            };
            CustomerOrderManagementController.prototype.initPagination = function () {
                this.currentPage = 1;
            ...
            CustomerOrderManagementController.prototype.getCustomerOrderListOnPage = function () {
            ...
            CustomerOrderManagementController.prototype.getNumberPage = function () {
                if (this.numOfPages > 0) {
                    return new Array(this.numOfPages);
                }
                return new Array(0);
            };
            CustomerOrderManagementController.prototype.goToPage = function (pageIndex) {
                this.currentPage = pageIndex;
            };
            CustomerOrderManagementController.prototype.goToPreviousPage = function () {
                if (this.currentPage > 1) {
                    this.currentPage--;
                    this.goToPage(this.currentPage);
                }
            };
            CustomerOrderManagementController.prototype.goToNextPage = function () {
                if (this.currentPage < this.numOfPages) {
                    this.currentPage++;
                    this.goToPage(this.currentPage);
                }
            };
            CustomerOrderManagementController.prototype.selectAllCustomerOrdersOnPage = function () {
            ...
            CustomerOrderManagementController.prototype.removeCustomerOrders = function () {
                var _this = this;
                ...
                if (confirmDialog) {
                    for (var i = 0; i < this.customerOrderList.length; i++) {
                        ...
                        if (customerOrder.isChecked) {
                            this.customerOrderService.deleteEntity(customerOrder, function (data) {
                                _this.initCustomerOrderList();
                            }, function () { });
                        }
                    }
                }
            };
            CustomerOrderManagementController.prototype.removeCustomerOrderInDetail = function (customerOrder) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa đơn hàng của khách hàng này?');
                if (confirmDialog) {
                    this.customerOrderService.deleteEntity(customerOrder, function (data) {
                        _this.$location.path('/ql-toa-hang/don-hang-cua-khach');
                    }, null);
                }
            };
            CustomerOrderManagementController.prototype.createCustomerOrder = function (customerOrder) {
                var _this = this;
                if (customerOrder.customerId) {
                    this.customerOrderService.create(customerOrder, function (data) {
                        _this.$location.path('/ql-toa-hang/don-hang-cua-khach');
                    }, function () { });
                }
                else {
                    var newCustomer = new Clarity.Model.CustomerModel();
                    ...
                    this.customerService.create(newCustomer, function (data) {
                        customerOrder.customerId = data.id;
                        customerOrder.customerCode = data.code;
                        _this.customerOrderService.create(customerOrder, function (data) {
                            _this.$location.path('/ql-toa-hang/don-hang-cua-khach');
                        }, function () { });
                    }, null);
                }
            };
            CustomerOrderManagementController.prototype.updateCustomerOrder = function (customerOrder) {
                var _this = this;
                this.customerOrderService.update(customerOrder, function (data) {
                    _this.$location.path('/ql-toa-hang/don-hang-cua-khach');
                }, null);
            };
            CustomerOrderManagementController.prototype.goToCustomerOrderForm = function () {
                this.$location.path('/ql-toa-hang/don-hang-cua-khach/tao');
            };
            CustomerOrderManagementController.prototype.applyCustomer = function (id) {
            ...
            CustomerOrderManagementController.prototype.getEmployeeName = function (id) {
                if (this.employeeList) {
                    for (var i = 0; i < this.employeeList.length; i++) {
                        var employee = this.employeeList[i];
                        if (employee.id == id) {
            ...
            CustomerOrderManagementController.prototype.changeFormatNumber = function (changeFormatNumber) {
                if (changeFormatNumber && changeFormatNumber != '') {
                    this.currentCustomerOrder.unitPrice = parseInt(changeFormatNumber.replace(/,/g, ''));
            ...
            CustomerOrderManagementController.prototype.getCustomCode = function (id) {
            ...
            CustomerOrderManagementController.prototype.calculateTotalPay = function () {
            ...
            CustomerOrderManagementController.prototype.getCustomerOrderCode = function () {
            ...
            CustomerOrderManagementController.prototype.getTruckLicensePlate = function (id) {
                if (this.truckList) {
                    for (var i = 0; i < this.truckList.length; i++) {
                        var truck = this.truckList[i];
                        if (truck.id == id) {
            ...
            return CustomerOrderManagementController;
        }());
        Controller.CustomerOrderManagementController = CustomerOrderManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
        ...
        var WagonManagementController = (function () {
            ...
            WagonManagementController.prototype.initWagonList = function () {
                ...
                this.wagonService.getAll(function (results) {
                    ...
                    for (var i = 0; i < _this.wagonList.length; i++) {
                        var currentWagon = _this.wagonList[i];
                    }
                    _this.wagonListTmp = _this.wagonList;
                    _this.initPagination();
                }, null);
            };
            ...
            WagonManagementController.prototype.getCustomerCode = function (id) {
                var _this = this;
                if (this.customerList) {
                    for (var i = 0; i < this.customerList.length; i++) {
                        var customer = this.customerList[i];
                    ...
                    this.customerService.getAll(function (results) {
                        ...
                        for (var i = 0; i < _this.customerList.length; i++) {
                            var customer = _this.customerList[i];
                            if (customer.id === id) {
                                return customer.code;
                            }
                        }
            ...
            WagonManagementController.prototype.initCustomerOrderList = function () {
                var _this = this;
                this.customerOrderService.getAll(function (results) {
                    _this.customerOrderList = results;
                    _this.getTruckListInCustomerOrder();
                }, null);
            };
            ...
            WagonManagementController.prototype.exportWagonToExcel = function (wagon) {
                this.exportService.exportWagonToExcel(wagon, function (data) {
            ...
            WagonManagementController.prototype.bindDataCustomerOrderTowagonSettlement = function (wagonSettlement, customerOrderId) {
                var _this = this;
                this.customerOrderList.map(function (customerOrder) {
                    if (customerOrder.id == customerOrderId) {
                        ...
                        wagonSettlement.date = _this.mainHelper.formatDateTimeDDMMYYYY(customerOrder.createdDate);
                        ...
                        wagonSettlement.paymentPlace = _this.currentWagon.paymentPlace;
                        wagonSettlement.wagonCode = _this.currentWagon.code;
            ...
            WagonManagementController.prototype.updateWagonSettlementPayment = function (wagonSettlement, paymentFormated, discountFormated) {
            ...
            WagonManagementController.prototype.showEditWagonSettlement = function (wagonSettlement) {
                var customerOrderId = parseInt(wagonSettlement.customerOrderId.toString());
                if (angular.isNumber(customerOrderId) && !isNaN(customerOrderId)) {
                    return true;
                }
                return false;
            };
            WagonManagementController.prototype.onChangeWagonSettlementQuatity = function (wagonSettlement) {
                wagonSettlement.totalAmount = wagonSettlement.quantity * wagonSettlement.unitPrice;
            };
            WagonManagementController.prototype.resetWagonSettlement = function (wagonSettlement) {
                this.customerOrderList.map(function (customerOrder) {
            ...
            WagonManagementController.prototype.getMaxQualityWagonSettlement = function (wagonSettlement) {
                var max = wagonSettlement.quantity;
                return max;
            };
            WagonManagementController.prototype.getTruckListInCustomerOrder = function () {
                if (this.customerOrderList && this.truckList) {
                    this.truckListInCustomerOrder = angular.copy(this.truckList);
                    for (var i = this.truckListInCustomerOrder.length - 1; i >= 0; i--) {
                        var truck = this.truckListInCustomerOrder[i];
                        var foundTruck = false;
                        for (var j = 0; j < this.customerOrderList.length; j++) {
            ...
            WagonManagementController.prototype.formatedCurencyForWagon = function () {
            ...
            WagonManagementController.prototype.setFormatedCurencyForWagon = function (changeFormatNumber, type) {
                if (changeFormatNumber && changeFormatNumber != '') {
                    switch (type) {
                        case '0':
            ...
            WagonManagementController.prototype.getWagonCode = function () {
            ...
            WagonManagementController.prototype.getTruckLicensePlate = function (id) {
                var _this = this;
                if (this.truckList) {
                    for (var i = 0; i < this.truckList.length; i++) {
                        var truck = this.truckList[i];
                    ...
                    this.truckService.getAll(function (results) {
                        _this.$rootScope.truckList = results;
                        _this.truckList = _this.$rootScope.truckList;
                        for (var i = 0; i < _this.truckList.length; i++) {
                            var truck = _this.truckList[i];
                            if (truck.id == id) {
                                return truck.licensePlate;
                            }
                        }
            ...
            WagonManagementController.prototype.getEmployeeName = function (id) {
                var _this = this;
                if (this.employeeList) {
                    for (var i = 0; i < this.employeeList.length; i++) {
                        var employee = this.employeeList[i];
                    ...
                    this.employeeService.getAll(function (results) {
                        ...
                        for (var i = 0; i < _this.employeeList.length; i++) {
                            var employee = _this.employeeList[i];
                            if (employee.id == id) {
                                return employee.fullName;
                            }
                        }
        ...
        var WagonSettlementManagementController = (function () {
            ...
            WagonSettlementManagementController.prototype.initWagonSettlement = function () {
                ...
                if (wagonId) {
                    if (this.$location.path() === '/ql-toa-hang/quyet-toan/' + wagonId) {
                        this.wagonSettlementService.getById(wagonId, function (data) {
                        ...
                        if (this.currentWagonSettlement == null) {
                            this.wagonSettlementService.getById(wagonId, function (data) {
                                _this.currentWagonSettlement = data;
                                _this.currentWagonSettlement.customerCode = _this.getCustomerCode(_this.currentWagonSettlement.customerId);
                            }, null);
                        }
                    }
                }
            ...
            WagonSettlementManagementController.prototype.initWagonSettlementList = function () {
                ...
                this.wagonSettlementService.getAll(function (results) {
                    ...
                    _this.wagonSettlementListTmp = _this.wagonSettlementList;
                    _this.initPagination();
                }, null);
            };
            WagonSettlementManagementController.prototype.initEmployeeList = function () {
                var _this = this;
                this.employeeService.getAll(function (results) {
                    _this.employeeList = results;
                }, null);
            ...
            WagonSettlementManagementController.prototype.getCustomerCode = function (id) {
                var _this = this;
                if (this.customerList) {
                    for (var i = 0; i < this.customerList.length; i++) {
                        var customer = this.customerList[i];
            ...
            WagonSettlementManagementController.prototype.updateNewPayment = function (newPayment) {
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var ReportManagementController = (function () {
            ...
            ReportManagementController.prototype.viewCustomerOrder = function () {
                var _this = this;
                this.isViewLoading = true;
                this.orderCustomerService.getCustomerOrdersByDate({ fromDate: this.fromDate, toDate: this.toDate }, function (data) {
                    _this.isViewLoading = false;
                    _this.filteredCustomerOrders = data;
                }, null);
            };
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var ProductManagementController = (function () {
            function ProductManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
        ...
        var OrderManagementController = (function () {
            ...
            OrderManagementController.prototype.initOrderList = function () {
                ...
                this.orderService.getAll(function (results) {
                    _this.orderList = results;
                    _this.orderList.sort(function (a, b) {
                        return b.id - a.id;
                    });
                    _this.productInputListTmp = _this.orderList;
                    _this.initPagination();
                    _this.isLoading = false;
                }, null);
            };
            ...
            OrderManagementController.prototype.restoreOrder = function (order) {
                var _this = this;
                order.status = true;
                this.orderService.changeOrderStatus(order, function (data) {
            ...
            OrderManagementController.prototype.goToOrderPrintPage = function (event, order) {
                event.stopPropagation();
        ...
        var InputOrderManagementController = (function () {
            ...
            InputOrderManagementController.prototype.initInputOrderList = function () {
                ...
                this.inputOrderService.getAll(function (results) {
                    ...
                    _this.inputOrderListTmp = _this.inputOrderList;
                    _this.initPagination();
                    _this.isLoading = false;
                }, null);
            };
            ...
            InputOrderManagementController.prototype.removeOrders = function () {
                ...
                if (confirmDialog) {
                    for (var i = 0; i < this.inputOrderList.length; i++) {
            ...
            InputOrderManagementController.prototype.setFormatedCurencyForProductInput = function (productInput, type) {
                if (type == 0) {
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var ProductInfoManagementController = (function () {
            function ProductInfoManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            ProductInfoManagementController.prototype.initProductInfoList = function () {
                ...
                this.productService.getAllProductInfo(function (results) {
                    ...
                    _this.orderBy('name');
                    _this.productInfoListTmp = _this.productInfoList;
                    _this.initPagination();
                    _this.isLoading = false;
                }, null);
            };
