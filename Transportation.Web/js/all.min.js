...
(function (Clarity) {
    ...
    (function (Service) {
        var BaseService = (function () {
            ...
            BaseService.prototype.getPerPage = function (pageIndex, pageSize, successCallback, errorCallback) {
                var _this = this;
                this.http.get(this.url + "/page?pageIndex=" + pageIndex + "&pageSize=" + pageSize)
                    .success(function (data) { _this.doCallback(successCallback, data); })
                    .error(function (data, status) { _this.doCallback(errorCallback, data, status); });
            };
            BaseService.prototype.getNumOfPages = function (pageSize, successCallback, errorCallback) {
                var _this = this;
        ...
        var EmployeeManagementController = (function () {
            function EmployeeManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                ...
                $scope.$watch('viewModel.searchText', function (value) {
                    if (_this.employeeListViewFilter && _this.employeeListViewFilter.length > 0) {
                        _this.employeeListView = $filter('filter')(_this.employeeListViewFilter, value);
                    }
                });
            ...
            EmployeeManagementController.prototype.fetchEmployeeListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.employeeService.getPerPage(this.currentPage, this.pageSize, function (results) {
                    _this.employeeList = results;
                    _this.mapToEmployeeListView();
                    _this.employeeListViewFilter = _this.employeeListView;
                    _this.isLoading = false;
                }, null);
            };
            EmployeeManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.employeeService.getNumOfPages(this.pageSize, function (results) {
                    _this.currentPage = 0;
    ...
    (function (Controller) {
        ...
        var TruckManagementController = (function () {
            function TruckManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                ...
                this.initTruck();
                $scope.$watch('viewModel.searchText', function (value) {
                    if (_this.truckListViewFilter && _this.truckListViewFilter.length > 0) {
                        _this.truckListView = $filter('filter')(_this.truckListViewFilter, value);
                    }
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
            ...
            TruckManagementController.prototype.fetchTruckListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.truckService.getPerPage(this.currentPage, this.pageSize, function (results) {
                    _this.truckList = results;
                    _this.mapToTruckListView();
                    _this.truckListViewFilter = _this.truckListView;
                    _this.isLoading = false;
                }, null);
            };
            TruckManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.truckService.getNumOfPages(this.pageSize, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                }, null);
            };
            ...
            TruckManagementController.prototype.initEmployeeList = function () {
                var _this = this;
                this.employeeService.getAll(function (results) {
                    _this.employeeList = results;
                    _this.$rootScope.hideSpinner();
                }, null);
            };
    ...
    (function (Controller) {
        ...
        var CustomerManagementController = (function () {
            ...
            CustomerManagementController.prototype.fetchCustomerListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.customerService.getPerPage(this.currentPage, this.pageSize, function (results) {
                    _this.customerList = results;
                    _this.mapToCustomerListView();
                    _this.customerListViewFilter = _this.customerListView;
                    _this.isLoading = false;
                }, null);
            };
            CustomerManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.customerService.getNumOfPages(this.pageSize, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                }, null);
            };
    ...
    (function (Controller) {
        ...
        var WagonManagementController = (function () {
            function WagonManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                ...
                this.initWagon();
                $scope.$watch('viewModel.searchText', function (value) {
                    if (_this.wagonListViewFilter && _this.wagonListViewFilter.length > 0) {
                        _this.wagonListView = $filter('filter')(_this.wagonListViewFilter, value);
                    }
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
            ...
            WagonManagementController.prototype.fetchWagonListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.wagonService.getPerPage(this.currentPage, this.pageSize, function (results) {
                    _this.wagonList = results;
                    _this.mapToWagonListView();
                    _this.wagonListViewFilter = _this.wagonListView;
                    _this.isLoading = false;
                }, null);
            };
            WagonManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.wagonService.getNumOfPages(this.pageSize, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                }, null);
            };
            ...
            WagonManagementController.prototype.initTruckList = function () {
                var _this = this;
                this.truckService.getAll(function (results) {
    ...
    (function (Controller) {
        ...
        var ProductManagementController = (function () {
            ...
            ProductManagementController.prototype.fetchProductListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.productService.getPerPage(this.currentPage, this.pageSize, function (results) {
            ...
            ProductManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.productService.getNumOfPages(this.pageSize, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                }, null);
            };
    ...
    (function (Controller) {
        ...
        var OrderManagementController = (function () {
            ...
            OrderManagementController.prototype.fetchOrderListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.orderService.getPerPage(this.currentPage, this.pageSize, function (results) {
            ...
            OrderManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.orderService.getNumOfPages(this.pageSize, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                }, null);
            };
    ...
    (function (Controller) {
        ...
        var InputOrderManagementController = (function () {
            ...
            InputOrderManagementController.prototype.fetchInputOrderListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.inputOrderService.getPerPage(this.currentPage, this.pageSize, function (results) {
            ...
            InputOrderManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.inputOrderService.getNumOfPages(this.pageSize, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                }, null);
            };
