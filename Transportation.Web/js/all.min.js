...
(function (Clarity) {
    var Controller;
    (function (Controller) {
        var WagonsManagementController = (function () {
            function WagonsManagementController($scope, $rootScope, $http, $location, $window, $filter) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            WagonsManagementController.prototype.goToEmployeeForm = function () {
                this.$location.path('/');
            };
            return WagonsManagementController;
        }());
        Controller.WagonsManagementController = WagonsManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
