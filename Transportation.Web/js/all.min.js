        ...
        var TransportationManagementController = (function () {
            ...
            TransportationManagementController.prototype.fetchOrderListPerPage = function () {
                ...
                if (!this.truckLicensePlate || !this.fromDate || !this.toDate)
                    return;
                this.isLoading = true;
                this.orderService.getTruckInfoPerPage(this.currentPage, this.pageSize, this.searchText, this.truckLicensePlate, this.fromDate, this.toDate, function (results) {
                    _this.initOrderListAfterCallAsync(results);
                });
            };
            TransportationManagementController.prototype.fetchNumOfPages = function () {
                ...
                if (!this.truckLicensePlate || !this.fromDate || !this.toDate)
                    return;
                this.orderService.getTruckInfoNumOfPages(this.pageSize, this.searchText, this.truckLicensePlate, this.fromDate, this.toDate, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
