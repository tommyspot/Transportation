...
(function (Clarity) {
    ...
    (function (Helper) {
        var MainHelper = (function () {
            ...
            MainHelper.prototype.formatCurrency = function (object, propertyName, formattedPropertyName) {
            ...
            MainHelper.prototype.initFormattedProperty = function (object, propertyNames, formatSuffix) {
                ...
                if (truckId) {
                    if (this.$location.path() === '/ql-toa-hang/xe/' + truckId) {
                        this.truckService.getById(truckId, function (data) {
                            ...
                            _this.mainHelper.initFormattedProperty(_this.currentTruck, ['monthlyPayment'], formatSuffix);
                            _this.initEmployeeList();
                        }, null);
                    }
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var CustomerManagementController = (function () {
            function CustomerManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
                ...
                if (customerId) {
                    if (this.$location.path() === '/ql-toa-hang/khach-hang/' + customerId) {
                        this.customerService.getById(customerId, function (data) {
                            ...
                            _this.mainHelper.initFormattedProperty(_this.currentCustomer, ['totalOwned', 'totalPay', 'totalDebt'], formatSuffix);
                        }, null);
                    }
            ...
            CustomerManagementController.prototype.formatCurrency = function (propertyName) {
                ...
                if (this.currentWagon) {
                    ...
                    if (this.currentWagon.wagonSettlements && this.currentWagon.wagonSettlements.length > 0) {
                        ...
                        wagonSettelments.forEach(function (wagonSettelment) {
                            _this.mainHelper.initFormattedProperty(wagonSettelment, wagonSettlementFormattedProperties_1, formatSufix);
                        });
                    }
                    this.totalAmountWagonSettlements = this.calculateTotalAmountWagonSettlements(this.currentWagon);
                }
                    ...
                    if (this.$location.path() === '/ql-toa-hang/quyet-toan/' + wagonId) {
                        ...
                        if (this.currentWagonSettlement == null) {
                            this.wagonSettlementService.getById(wagonId, function (data) {
                                ...
                                _this.mainHelper.initFormattedProperty(_this.currentWagonSettlement, ['unitPrice'], formatSuffix);
