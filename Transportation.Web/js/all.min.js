                ...
                if (truckId) {
                    if (this.$location.path() === '/ql-toa-hang/xe/' + truckId) {
                        ...
                        if (this.currentTruck == null) {
                            this.truckService.getById(truckId, function (data) {
                                _this.currentTruck = data;
                                _this.currentTruck.startUsingDate = new Date(data.startUsingDate);
                                _this.currentTruck.buyingDate = new Date(data.buyingDate);
                                _this.currentTruck.checkDate = new Date(data.checkDate);
                                _this.currentTruck.insuranceDate = new Date(data.insuranceDate);
                            }, null);
                        }
                    }
                }
