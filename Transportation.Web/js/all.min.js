    ...
    (function (Controller) {
        ...
        var ReportManagementController = (function () {
            ...
            ReportManagementController.prototype.exportCustomer = function () {
                var _this = this;
                this.isExportLoading = true;
                this.exportService.exportToExcel({ type: model.ExportType.Customer }, function (data) {
                    _this.isExportLoading = false;
                    window.location.href = '/output/' + data['fileName'];
                }, function () {
                    _this.isExportLoading = false;
        ...
        var OrderManagementController = (function () {
            ...
            OrderManagementController.prototype.shouldOrderDetailSetDefault = function (orderDetail, index) {
                if (this.originOrderDetails == null)
                    return true;
                var originOrderDetail = this.originOrderDetails && this.originOrderDetails[index];
                if (originOrderDetail == null)
                    return true;
                return false;
            };
