...
(function (Clarity) {
    ...
    (function (Service) {
        var ProductService = (function (_super) {
            ...
            ProductService.prototype.getProductInfoPerPage = function (pageIndex, pageSize, successCallback, errorCallback) {
                var _this = this;
...
(function (Clarity) {
    ...
    (function (Service) {
        var OrderService = (function (_super) {
            ...
            OrderService.prototype.getDeletedOrdersPerPage = function (pageIndex, pageSize, successCallback, errorCallback) {
                var _this = this;
                this.http.get("/api/deletedOrders/page?pageIndex=" + pageIndex + "&pageSize=" + pageSize)
                    .success(function (data) { _this.doCallback(successCallback, data); })
                    .error(function (data, status) { _this.doCallback(errorCallback, data, status); });
            };
            OrderService.prototype.getDeletedOrdersNumOfPages = function (pageSize, successCallback, errorCallback) {
                var _this = this;
    ...
    (function (Controller) {
        ...
        var ProductManagementController = (function () {
            function ProductManagementController($scope, $rootScope, $http, $location, $window, $filter, $timeout, $routeParams) {
                ...
                this.initProduct();
                $scope.$watch('viewModel.searchText', function (value) {
                    if (_this.productListFilter && _this.productListFilter.length > 0) {
                        _this.productList = $filter('filter')(_this.productListFilter, value);
                    }
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
            ...
            ProductManagementController.prototype.fetchProductListPerPage = function () {
                ...
                this.productService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    ...
                    _this.productListFilter = _this.productList;
                    _this.isLoading = false;
                });
            };
    ...
    (function (Controller) {
        ...
        var OrderManagementController = (function () {
            function OrderManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $routeParams) {
                ...
                this.initOrder();
                $scope.$watch('viewModel.searchText', function (value) {
                    if (_this.orderListViewFilter && _this.orderListViewFilter.length > 0) {
                        _this.orderListView = $filter('filter')(_this.orderListViewFilter, value);
                    }
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
            ...
            OrderManagementController.prototype.fetchDeletedOrderListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.orderService.getDeletedOrdersPerPage(this.currentPage, this.pageSize, function (results) {
                    _this.initOrderListAfterCallAsync(results);
                }, null);
            };
            ...
            OrderManagementController.prototype.fetchDeletedOrderNumOfPages = function () {
                var _this = this;
                this.orderService.getDeletedOrdersNumOfPages(this.pageSize, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                }, null);
            };
    ...
    (function (Controller) {
        ...
        var InputOrderManagementController = (function () {
            function InputOrderManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $routeParams) {
                ...
                this.initInputOrder();
                $scope.$watch('viewModel.searchText', function (value) {
                    if (_this.inputOrderListViewFilter && _this.inputOrderListViewFilter.length > 0) {
                        _this.inputOrderListView = $filter('filter')(_this.inputOrderListViewFilter, value);
                    }
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
            ...
            InputOrderManagementController.prototype.fetchInputOrderListPerPage = function () {
                ...
                this.inputOrderService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    ...
                    _this.inputOrderListViewFilter = _this.inputOrderListView;
                    _this.isLoading = false;
                });
            };
    ...
    (function (Controller) {
        ...
        var ProductInfoManagementController = (function () {
            function ProductInfoManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $routeParams) {
                ...
                this.initProduct();
                $scope.$watch('viewModel.searchText', function (value) {
                    if (_this.productInfoListViewFilter && _this.productInfoListViewFilter.length > 0) {
                        _this.productInfoListView = $filter('filter')(_this.productInfoListViewFilter, value);
                    }
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
            ...
            ProductInfoManagementController.prototype.fetchProductInfoListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.productService.getProductInfoPerPage(this.currentPage, this.pageSize, function (results) {
