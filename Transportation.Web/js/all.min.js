...
(function (Clarity) {
    ...
    (function (Helper) {
        var MainHelper = (function () {
            function MainHelper($http, $cookieStore, $filter) {
                this.$http = $http;
            ...
            MainHelper.prototype.formatDateTimeDDMMYYYY = function (d) {
            ...
            MainHelper.prototype.formatDateTimeDDMMYYYYNumber = function (d) {
                if (!(d instanceof Date)) {
                    d = new Date(date);
                }
                var year = d.getFullYear().toString();
            ...
            MainHelper.prototype.formatStringToDateTime = function (date) {
                var day = parseInt(date.split('/')[0]);
                var month = parseInt(date.split('/')[1]) - 1;
                var year = parseInt(date.split('/')[2]);
                return new Date(year, month, day);
            };
            MainHelper.prototype.formatCurrency = function (value) {
                if (value)
                    return this.$filter('currency')(value, '', this.isInt(value) ? 0 : 1).trim();
                return '0';
            };
            MainHelper.prototype.isInt = function (n) {
                return n % 1 === 0;
            };
            MainHelper.prototype.onCurrencyPropertyChanged = function (object, propertyName, formattedPropertyName) {
            ...
            MainHelper.prototype.initCurrencyFormattedProperty = function (object, propertyNames, formatSuffix) {
                var _this = this;
                propertyNames.forEach(function (property) {
                    if (object.hasOwnProperty(property)) {
                        object[("" + property + formatSuffix)] = _this.formatCurrency(object[property]);
                    }
                });
            };
            MainHelper.prototype.getPropertyValue = function (objectList, searchPropertyName, searchByValue, propertyName) {
                if (objectList && objectList.length > 0) {
                    var filterObjects = objectList.filter(function (object) {
            ...
            MainHelper.prototype.getObjectById = function (objectList, id) {
                if (objectList && objectList.length > 0) {
...
(function (Clarity) {
    ...
    (function (Model) {
        ...
        Model.EmployeeViewModel = EmployeeViewModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var TruckModel = (function (_super) {
            __extends(TruckModel, _super);
            function TruckModel() {
                _super.apply(this, arguments);
            }
            return TruckModel;
        ...
        var TruckViewModel = (function (_super) {
            __extends(TruckViewModel, _super);
            function TruckViewModel() {
                _super.apply(this, arguments);
            }
            return TruckViewModel;
        }(Model.BaseModel));
        Model.TruckViewModel = TruckViewModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var WagonModel = (function (_super) {
            __extends(WagonModel, _super);
            function WagonModel() {
                _super.apply(this, arguments);
            }
            return WagonModel;
        }(Model.BaseModel));
        Model.WagonModel = WagonModel;
        var WagonViewModel = (function (_super) {
            __extends(WagonViewModel, _super);
            function WagonViewModel() {
                _super.apply(this, arguments);
            }
            return WagonViewModel;
        }(Model.BaseModel));
        Model.WagonViewModel = WagonViewModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var WagonSettlementModel = (function (_super) {
            __extends(WagonSettlementModel, _super);
            function WagonSettlementModel() {
                _super.apply(this, arguments);
            }
            return WagonSettlementModel;
        }(Model.BaseModel));
        Model.WagonSettlementModel = WagonSettlementModel;
        var WagonSettlementViewModel = (function (_super) {
            __extends(WagonSettlementViewModel, _super);
            function WagonSettlementViewModel() {
                _super.apply(this, arguments);
            }
            return WagonSettlementViewModel;
        }(Model.BaseModel));
        Model.WagonSettlementViewModel = WagonSettlementViewModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var PaymentModel = (function (_super) {
...
(function (Clarity) {
    ...
    (function (Model) {
        (function (ExportType) {
            ExportType[ExportType["Truck"] = 0] = "Truck";
            ExportType[ExportType["Employee"] = 1] = "Employee";
            ExportType[ExportType["Customer"] = 2] = "Customer";
            ExportType[ExportType["OrderCustomer"] = 3] = "OrderCustomer";
            ExportType[ExportType["Wagon"] = 4] = "Wagon";
            ExportType[ExportType["WagonSettlement"] = 5] = "WagonSettlement";
            ExportType[ExportType["GarageOrder"] = 6] = "GarageOrder";
            ExportType[ExportType["GarageInputOrder"] = 7] = "GarageInputOrder";
            ExportType[ExportType["GarageProductInfoOrder"] = 8] = "GarageProductInfoOrder";
        })(Model.ExportType || (Model.ExportType = {}));
        var ExportType = Model.ExportType;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var CustomerReportModel = (function (_super) {
            __extends(CustomerReportModel, _super);
            function CustomerReportModel() {
                _super.call(this);
                this.isCheckedAll = true;
            }
            return CustomerReportModel;
        }(Model.BaseModel));
        Model.CustomerReportModel = CustomerReportModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var WagonReportModel = (function (_super) {
            __extends(WagonReportModel, _super);
            function WagonReportModel() {
                _super.apply(this, arguments);
            }
            return WagonReportModel;
        }(Model.BaseModel));
        Model.WagonReportModel = WagonReportModel;
        var WagonReportDataModel = (function () {
            function WagonReportDataModel() {
            }
            return WagonReportDataModel;
        }());
        Model.WagonReportDataModel = WagonReportDataModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var WagonSettlementReportModel = (function (_super) {
            __extends(WagonSettlementReportModel, _super);
            function WagonSettlementReportModel() {
                _super.apply(this, arguments);
            }
            return WagonSettlementReportModel;
        }(Model.BaseModel));
        Model.WagonSettlementReportModel = WagonSettlementReportModel;
        var WagonSettlementReportDataModel = (function () {
            function WagonSettlementReportDataModel() {
            }
            return WagonSettlementReportDataModel;
        }());
        Model.WagonSettlementReportDataModel = WagonSettlementReportDataModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Model) {
        ...
        var ProductInfoModel = (function (_super) {
            __extends(ProductInfoModel, _super);
            function ProductInfoModel() {
                _super.apply(this, arguments);
            }
            return ProductInfoModel;
        }(Model.BaseModel));
        Model.ProductInfoModel = ProductInfoModel;
        var ProductInfoViewModel = (function (_super) {
            __extends(ProductInfoViewModel, _super);
            function ProductInfoViewModel() {
                _super.apply(this, arguments);
            }
            return ProductInfoViewModel;
        }(Model.BaseModel));
        Model.ProductInfoViewModel = ProductInfoViewModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var ProductInputModel = (function (_super) {
            __extends(ProductInputModel, _super);
            function ProductInputModel() {
                _super.apply(this, arguments);
            }
            return ProductInputModel;
        }(Model.BaseModel));
        Model.ProductInputModel = ProductInputModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Model) {
        ...
        var OrderDetailModel = (function (_super) {
        ...
        Model.OrderDetailModel = OrderDetailModel;
        var OrderViewModel = (function (_super) {
        ...
        Model.OrderViewModel = OrderViewModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var InventoryModel = (function (_super) {
        ...
        var InventoryViewModel = (function (_super) {
            __extends(InventoryViewModel, _super);
            function InventoryViewModel() {
                _super.apply(this, arguments);
            }
            return InventoryViewModel;
        }(Model.BaseModel));
        Model.InventoryViewModel = InventoryViewModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Model;
    (function (Model) {
        var InputOrderModel = (function (_super) {
            __extends(InputOrderModel, _super);
            function InputOrderModel() {
                _super.call(this);
                this.productInputs = new Array();
            }
            return InputOrderModel;
        }(Model.BaseModel));
        Model.InputOrderModel = InputOrderModel;
        var InputOrderViewModel = (function (_super) {
            __extends(InputOrderViewModel, _super);
            function InputOrderViewModel() {
                _super.apply(this, arguments);
            }
            return InputOrderViewModel;
        }(Model.BaseModel));
        Model.InputOrderViewModel = InputOrderViewModel;
    })(Model = Clarity.Model || (Clarity.Model = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Enum) {
        (function (Role) {
            ...
            Role[Role["WagonManagement"] = 1] = "WagonManagement";
            Role[Role["GarageManagement"] = 2] = "GarageManagement";
            Role[Role["ReportManagement"] = 3] = "ReportManagement";
            Role[Role["TransportationManagement"] = 4] = "TransportationManagement";
        })(Enum.Role || (Enum.Role = {}));
        var Role = Enum.Role;
    })(Enum = Clarity.Enum || (Clarity.Enum = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Service) {
        var BaseService = (function () {
            ...
            BaseService.prototype.getAllCurtail = function (successCallback, errorCallback) {
                var _this = this;
                this.http.get(this.url + "/curtail")
                    .success(function (data) { _this.doCallback(successCallback, data); })
                    .error(function (data, status) { _this.doCallback(errorCallback, data, status); });
            };
            BaseService.prototype.getPerPage = function (pageIndex, pageSize, searchText, successCallback, errorCallback) {
                var _this = this;
                var search = searchText ? searchText.trim() : '';
                this.http.get(this.url + "/page?pageIndex=" + pageIndex + "&pageSize=" + pageSize + "&search=" + search)
                    .success(function (data) { _this.doCallback(successCallback, data); })
                    .error(function (data, status) { _this.doCallback(errorCallback, data, status); });
            };
            BaseService.prototype.getNumOfPages = function (pageSize, searchText, successCallback, errorCallback) {
                var _this = this;
                var search = searchText ? searchText.trim() : '';
...
(function (Clarity) {
    var Service;
    (function (Service) {
        var TruckService = (function (_super) {
...
(function (Clarity) {
    ...
    (function (Service) {
        var CustomerService = (function (_super) {
            ...
            CustomerService.prototype.proccessFastPayment = function (id, successCallback, errorCallback) {
                var _this = this;
...
(function (Clarity) {
    var Service;
    (function (Service) {
        var WagonService = (function (_super) {
            __extends(WagonService, _super);
            function WagonService($http) {
                _super.call(this, $http);
                this.url = '/api/wagons';
            }
            WagonService.prototype.getById = function (id, successCallback, errorCallback) {
                var _this = this;
                this.http({ method: 'GET', url: this.url + '/' + id })
                    .success(function (data) {
            ...
            WagonService.prototype.getAll = function (successCallback, errorCallback) {
                var _this = this;
                this.http.get(this.url)
                    .success(function (data) {
            ...
            WagonService.prototype.getWagonReportByDate = function (dateObject, successCallback, errorCallback) {
                var _this = this;
            ...
            WagonService.prototype.getAllDepartureAndDestination = function (successCallback, errorCallback) {
                var _this = this;
        ...
        Service.WagonService = WagonService;
    })(Service = Clarity.Service || (Clarity.Service = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Service;
    (function (Service) {
        var WagonSettlementService = (function (_super) {
            __extends(WagonSettlementService, _super);
            function WagonSettlementService($http) {
                _super.call(this, $http);
                this.url = '/api/wagonSettlements';
            }
            WagonSettlementService.prototype.getById = function (id, successCallback, errorCallback) {
                var _this = this;
                this.http({ method: 'GET', url: this.url + '/' + id })
                    .success(function (data) {
                    _this.doCallback(successCallback, data);
            ...
            WagonSettlementService.prototype.getAll = function (successCallback, errorCallback) {
                var _this = this;
                this.http.get(this.url)
                    .success(function (data) {
                    for (var i = 0; i < data.length; i++) {
            ...
            WagonSettlementService.prototype.getWagonSettlementReportByDate = function (dateObject, successCallback, errorCallback) {
                var _this = this;
            ...
            return WagonSettlementService;
        }(Service.BaseService));
        Service.WagonSettlementService = WagonSettlementService;
    })(Service = Clarity.Service || (Clarity.Service = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Service) {
        var ExportService = (function () {
            ...
            ExportService.prototype.doCallback = function (callback, data, status) {
                if (callback) {
                    callback(data, status);
                }
            };
            ExportService.prototype.exportWagonToExcel = function (report, successCallback, errorCallback) {
                var _this = this;
                this.url = '/api/exportWagonToExcel';
                this.http.post(this.url, report)
                    .success(function (data, status) { _this.doCallback(successCallback, data, status); })
                    .error(function (data, status) { _this.doCallback(errorCallback, data, status); });
            };
            ExportService.prototype.exportToExcel = function (exportObject, successCallback, errorCallback) {
                var _this = this;
            ...
            ExportService.prototype.exportGarageToExcel = function (productInfoList, successCallback, errorCallback) {
                var _this = this;
            ...
            ExportService.prototype.deleteExcelFile = function (folderName, successCallback, errorCallback) {
                var _this = this;
...
(function (Clarity) {
    ...
    (function (Service) {
        var PaymentService = (function (_super) {
            ...
            PaymentService.prototype.getByWagonSettlementCode = function (code, successCallback, errorCallback) {
                var _this = this;
                this.http({ method: 'GET', url: this.url + '/' + code })
                    .success(function (data, status) { _this.doCallback(successCallback, data); })
                    .error(function (data, status) { _this.doCallback(errorCallback, data, status); });
            };
...
(function (Clarity) {
    ...
    (function (Service) {
        var ProductService = (function (_super) {
            ...
            ProductService.prototype.getProductInfoPerPage = function (pageIndex, pageSize, searchText, successCallback, errorCallback) {
                var _this = this;
                var search = searchText ? searchText.trim() : '';
...
(function (Clarity) {
    ...
    (function (Service) {
        var OrderService = (function (_super) {
            ...
            OrderService.prototype.getDeletedOrdersPerPage = function (pageIndex, pageSize, searchText, successCallback, errorCallback) {
                var _this = this;
                var search = searchText ? searchText.trim() : '';
            ...
            OrderService.prototype.getDeletedOrdersNumOfPages = function (pageSize, searchText, successCallback, errorCallback) {
                var _this = this;
                var search = searchText ? searchText.trim() : '';
            ...
            OrderService.prototype.changeOrderStatus = function (entity, successCallback, errorCallback) {
                var _this = this;
                this.http.put(this.url + '/status/' + entity.id, entity)
                    .success(function (data) { _this.doCallback(successCallback, data); })
                    .error(function (data, status) { _this.doCallback(errorCallback, data, status); });
            };
            OrderService.prototype.getTruckInfoPerPage = function (pageIndex, pageSize, searchText, truckLicensePlate, fromDate, toDate, successCallback, errorCallback) {
                var _this = this;
                var search = searchText ? searchText.trim() : '';
            ...
            OrderService.prototype.getTruckInfoNumOfPages = function (pageSize, searchText, truckLicensePlate, fromDate, toDate, successCallback, errorCallback) {
                var _this = this;
                var search = searchText ? searchText.trim() : '';
...
(function (Clarity) {
    var Service;
    (function (Service) {
        var InputOrderService = (function (_super) {
            __extends(InputOrderService, _super);
            function InputOrderService($http) {
                _super.call(this, $http);
                this.url = '/api/inputOrders';
            }
            return InputOrderService;
        }(Service.BaseService));
        Service.InputOrderService = InputOrderService;
    })(Service = Clarity.Service || (Clarity.Service = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var LoginController = (function () {
            function LoginController($scope, $location, $window, $rootScope, $http, $cookieStore, $filter) {
                this.$scope = $scope;
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var LogoutController = (function () {
            function LogoutController($scope, $location, $window, $rootScope, $http, $cookieStore, $filter) {
                this.$scope = $scope;
                this.$location = $location;
                this.$window = $window;
                this.$rootScope = $rootScope;
                ...
                $scope.viewModel = this;
                this.authenticationService = new service.AuthenticationService($http, $cookieStore);
                this.mainHelper = new Clarity.Helper.MainHelper($http, $cookieStore, $filter);
            }
            ...
            LogoutController.prototype.getCurrentUserName = function () {
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var MainController = (function () {
            function MainController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            MainController.prototype.goToUserManagement = function () {
                this.$location.path('/ql-dang-nhap');
            };
            MainController.prototype.goToReportManagement = function () {
                this.$location.path('/ql-bao-cao');
            };
            MainController.prototype.goToGarageManagement = function () {
                this.$location.path('/ql-garage');
            };
            MainController.prototype.goToProductManagement = function () {
                this.$location.path('/ql-garage/san-pham');
            };
            MainController.prototype.goToProductInputManagement = function () {
                this.$location.path('/ql-garage/nhap-kho');
            };
            MainController.prototype.goToSaleManagement = function () {
                this.$location.path('/ql-garage/ban-hang');
            };
            MainController.prototype.goToReportGarageManagement = function () {
                this.$location.path('/ql-garage/quan-ly');
            };
            MainController.prototype.goToTransportationManagement = function () {
                this.$location.path('/ql-phuong-tien');
            };
            MainController.prototype.isAdminRole = function () {
                return this.authenticateService.getUserRole() == Clarity.Enum.Role.Admin;
            };
            MainController.prototype.hasWagonManagementPermission = function () {
                return this.isAdminRole() || this.authenticateService.getUserRole() == Clarity.Enum.Role.WagonManagement;
            };
            MainController.prototype.hasGarageManagementPermission = function () {
                return this.isAdminRole() || this.authenticateService.getUserRole() == Clarity.Enum.Role.GarageManagement;
            };
            MainController.prototype.hasReportManagementPermission = function () {
                return this.isAdminRole() || this.authenticateService.getUserRole() == Clarity.Enum.Role.ReportManagement;
            };
            MainController.prototype.hasTransportationManagementPermission = function () {
                return this.isAdminRole() || this.authenticateService.getUserRole() == Clarity.Enum.Role.TransportationManagement;
            };
            MainController.prototype.hasUserManagementPermission = function () {
                return this.authenticateService.getUserRole() != Clarity.Enum.Role.TransportationManagement;
            };
...
(function (Clarity) {
    ...
    (function (Controller) {
        var service = Clarity.Service;
        var EmployeeManagementController = (function () {
            function EmployeeManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                ...
                this.initEmployee();
                $scope.$watch('viewModel.searchText', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.currentPage === 0 ? _this.fetchEmployeeListPerPage() : (function () { _this.currentPage = 0; })();
                    _this.fetchNumOfPages();
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.fetchEmployeeListPerPage();
                });
                $scope.$watch('viewModel.pageSize', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
            ...
            EmployeeManagementController.prototype.initEmployee = function () {
                ...
                if (employeeId) {
                    ...
                    if (this.$location.path() === '/ql-toa-hang/nhan-vien/tao') {
                        this.currentEmployee = new Clarity.Model.EmployeeModel();
                    }
            ...
            EmployeeManagementController.prototype.initCurrentEmployee = function (employeeId) {
                var _this = this;
                if (this.currentEmployee == null) {
                    this.$rootScope.showSpinner();
                    this.employeeService.getById(employeeId, function (data) {
                        _this.currentEmployee = data;
                        _this.$rootScope.hideSpinner();
                    }, null);
                }
            };
            EmployeeManagementController.prototype.initEmployeeList = function () {
                this.currentPage = 0;
                this.fetchEmployeeListPerPage();
                this.fetchNumOfPages();
            };
            EmployeeManagementController.prototype.fetchEmployeeListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.employeeService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.employeeList = results;
                    _this.mapToEmployeeListView();
                    _this.isLoading = false;
                });
            };
            EmployeeManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.employeeService.getNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
            EmployeeManagementController.prototype.mapToEmployeeListView = function () {
                this.employeeListView = this.employeeList.map(function (employee) {
                    var employeeView = new Clarity.Model.EmployeeViewModel();
            ...
            EmployeeManagementController.prototype.selectAllEmployeesOnPage = function () {
                var _this = this;
                this.employeeListView.map(function (employee) { return employee.isChecked = _this.isCheckedAll; });
            };
            EmployeeManagementController.prototype.removeEmployees = function () {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa những nhân viên được chọn?');
                if (confirmDialog) {
                    for (var i = 0; i < this.employeeListView.length; i++) {
                        var employee = this.employeeListView[i];
                        if (employee.isChecked) {
                            this.employeeService.deleteEntity(employee, function (data) {
                                _this.initEmployeeList();
                            }, null);
                        }
                    }
            ...
            EmployeeManagementController.prototype.removeEmployeeInDetail = function (employee) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa nhân viên này?');
                if (confirmDialog) {
                    this.employeeService.deleteEntity(employee, function (data) {
                        _this.$location.path('/ql-toa-hang/nhan-vien');
                    }, null);
                }
            };
            EmployeeManagementController.prototype.createEmployee = function (employee) {
                var _this = this;
                this.isSubmitting = true;
                this.employeeService.create(employee, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/nhan-vien');
                }, null);
            };
            EmployeeManagementController.prototype.updateEmployee = function (employee) {
                var _this = this;
                this.isSubmitting = true;
                this.employeeService.update(employee, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/nhan-vien');
                }, null);
            };
            EmployeeManagementController.prototype.goToEmployeeForm = function () {
                this.$location.path('/ql-toa-hang/nhan-vien/tao');
            };
            EmployeeManagementController.prototype.goToEmployeeEditForm = function (event, employeeId) {
                event.stopPropagation();
                this.$location.path("/ql-toa-hang/nhan-vien/sua/" + employeeId);
            };
            EmployeeManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            EmployeeManagementController.prototype.hasSelectedEmployee = function () {
                if (!this.employeeListView)
                    return false;
                return this.employeeListView.some(function (employee) { return employee.isChecked; });
            };
...
(function (Clarity) {
    ...
    (function (Controller) {
        var service = Clarity.Service;
        var helper = Clarity.Helper;
        var formatSuffix = 'Formatted';
        var TruckManagementController = (function () {
            function TruckManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                ...
                $scope.$watch('viewModel.searchText', function (newValue, oldValue) {
                    ...
                    _this.currentPage === 0 ? _this.fetchTruckListPerPage() : (function () { _this.currentPage = 0; })();
                    _this.fetchNumOfPages();
                });
                // Paging
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
            ...
            TruckManagementController.prototype.initTruck = function () {
                ...
                if (truckId) {
                    ...
                    if (this.$location.path() === '/ql-toa-hang/xe/tao') {
                        this.currentTruck = new Clarity.Model.TruckModel();
                        this.initEmployeeList();
                    }
            ...
            TruckManagementController.prototype.initTruckList = function () {
                this.currentPage = 0;
                this.fetchTruckListPerPage();
                this.fetchNumOfPages();
            };
            TruckManagementController.prototype.fetchTruckListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.truckService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.truckList = results;
                    _this.mapToTruckListView();
                    _this.isLoading = false;
                });
            };
            TruckManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.truckService.getNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
            TruckManagementController.prototype.initCurrentTruck = function (truckId) {
                var _this = this;
                if (this.currentTruck == null) {
                    this.$rootScope.showSpinner();
                    this.truckService.getById(truckId, function (data) {
                        _this.currentTruck = data;
                        _this.mainHelper.initCurrencyFormattedProperty(_this.currentTruck, ['monthlyPayment'], formatSuffix);
                        _this.initEmployeeList();
                    }, null);
                }
            };
            TruckManagementController.prototype.initEmployeeList = function () {
                var _this = this;
                this.employeeService.getAllCurtail(function (results) {
                    _this.employeeList = results;
                    _this.$rootScope.hideSpinner();
                }, null);
            };
            TruckManagementController.prototype.mapToTruckListView = function () {
                this.truckListView = this.truckList.map(function (truck) {
                    var truckView = new Clarity.Model.TruckViewModel();
            ...
            TruckManagementController.prototype.selectAllTrucksOnPage = function () {
                var _this = this;
                this.truckListView.map(function (truck) { return truck.isChecked = _this.isCheckedAll; });
            };
            TruckManagementController.prototype.removeTrucks = function () {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa những xe được chọn?');
                if (confirmDialog) {
                    for (var i = 0; i < this.truckListView.length; i++) {
                        var truck = this.truckListView[i];
                        if (truck.isChecked) {
                            this.truckService.deleteEntity(truck, function (data) {
                                _this.initTruckList();
                            }, null);
                        }
                    }
            ...
            TruckManagementController.prototype.removeTruckInDetail = function (truck) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa xe này?');
                if (confirmDialog) {
                    this.truckService.deleteEntity(truck, function (data) {
                        _this.$location.path('/ql-toa-hang/xe');
                    }, null);
                }
            };
            TruckManagementController.prototype.createTruck = function (truck) {
                var _this = this;
                this.isSubmitting = true;
                this.truckService.create(truck, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/xe');
                }, null);
            };
            TruckManagementController.prototype.updateTruck = function (truck) {
                var _this = this;
                this.isSubmitting = true;
                this.truckService.update(truck, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/xe');
                }, null);
            };
            TruckManagementController.prototype.goToTruckForm = function () {
                this.$location.path('/ql-toa-hang/xe/tao');
            };
            TruckManagementController.prototype.goToTruckEditForm = function (event, truckId) {
                event.stopPropagation();
                this.$location.path("/ql-toa-hang/xe/sua/" + truckId);
            };
            TruckManagementController.prototype.getEmployeeName = function (employeeId) {
                return this.mainHelper.getPropertyValue(this.employeeList, 'id', employeeId, 'fullName');
            };
            TruckManagementController.prototype.formatCurrency = function (propertyName) {
                this.mainHelper.onCurrencyPropertyChanged(this.currentTruck, propertyName, "" + propertyName + formatSuffix);
            };
            TruckManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            TruckManagementController.prototype.hasSelectedTruck = function () {
                if (!this.truckListView)
                    return false;
                return this.truckListView.some(function (truck) { return truck.isChecked; });
            };
            return TruckManagementController;
        }());
        Controller.TruckManagementController = TruckManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var helper = Clarity.Helper;
        var formatSuffix = 'Formatted';
        var CustomerManagementController = (function () {
            function CustomerManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore, $timeout) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                ...
                $scope.$watch('viewModel.searchText', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.currentPage === 0 ? _this.fetchCustomerListPerPage() : (function () { _this.currentPage = 0; })();
                    _this.fetchNumOfPages();
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.fetchCustomerListPerPage();
                });
                $scope.$watch('viewModel.pageSize', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
            ...
            CustomerManagementController.prototype.isEditMode = function () {
                var customerId = this.$routeParams.customer_id;
                return !!customerId;
            };
            ;
            CustomerManagementController.prototype.initCustomer = function () {
                if (this.isEditMode()) {
                    var customerId = this.$routeParams.customer_id;
                    ...
                    if (this.$location.path() === '/ql-toa-hang/khach-hang/tao') {
                        this.currentCustomer = new Clarity.Model.CustomerModel();
                        this.initEmployeeList();
                    }
            ...
            CustomerManagementController.prototype.initCurrentCustomer = function (customerId) {
                var _this = this;
                if (this.currentCustomer == null) {
                    this.$rootScope.showSpinner();
                    this.customerService.getById(customerId, function (data) {
                        _this.currentCustomer = data;
                        _this.currentCustomer.paymentMonth = (new Date()).getMonth() + 1;
                        _this.currentCustomer.paymentYear = (new Date()).getFullYear();
                        _this.mainHelper.initCurrencyFormattedProperty(_this.currentCustomer, ['totalOwned', 'totalPay', 'totalDebt'], formatSuffix);
                        _this.$rootScope.hideSpinner();
                    }, null);
                }
            };
            CustomerManagementController.prototype.initCustomerList = function () {
                this.currentPage = 0;
                this.fetchCustomerListPerPage();
                this.fetchNumOfPages();
            };
            CustomerManagementController.prototype.fetchCustomerListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.customerService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.customerList = results;
                    _this.mapToCustomerListView();
                    _this.isLoading = false;
                });
            };
            CustomerManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.customerService.getNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
            CustomerManagementController.prototype.initEmployeeList = function () {
                var _this = this;
                this.employeeService.getAllCurtail(function (results) {
                    _this.employeeList = results;
                }, null);
            };
            CustomerManagementController.prototype.mapToCustomerListView = function () {
                var _this = this;
                this.customerListView = this.customerList.map(function (customer) {
                    _this.mainHelper.initCurrencyFormattedProperty(customer, ['totalOwned', 'totalPay', 'totalDebt'], formatSuffix);
                    var customerView = new Clarity.Model.CustomerViewModel();
            ...
            CustomerManagementController.prototype.selectAllCustomersOnPage = function () {
                var _this = this;
                this.customerListView.map(function (customer) { return customer.isChecked = _this.isCheckedAll; });
            };
            CustomerManagementController.prototype.removeCustomers = function () {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa những khách hàng được chọn?');
                if (confirmDialog) {
                    for (var i = 0; i < this.customerListView.length; i++) {
                        var customer = this.customerListView[i];
                        if (customer.isChecked) {
                            this.customerService.deleteEntity(customer, function (data) {
                                _this.initCustomerList();
                            }, function (error) {
                                _this.errorMessage = 'Khách hàng được chọn đã có trong Quyết toán';
            ...
            CustomerManagementController.prototype.removeCustomerInDetail = function (customer) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa khách hàng này?');
                if (confirmDialog) {
                    this.customerService.deleteEntity(customer, function (data) {
                        _this.$location.path('/ql-toa-hang/khach-hang');
                    }, function (error) {
                        _this.errorMessage = 'Khách hàng đã có trong Quyết toán';
                        _this.$timeout(function () {
                            _this.errorMessage = '';
                        }, 8000);
                    });
            ...
            CustomerManagementController.prototype.createCustomer = function (customer) {
                var _this = this;
                this.isSubmitting = true;
                this.customerService.create(customer, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/khach-hang');
                }, null);
            };
            CustomerManagementController.prototype.updateCustomer = function (customer) {
                var _this = this;
                this.isSubmitting = true;
                this.customerService.update(customer, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/khach-hang');
                }, null);
            };
            CustomerManagementController.prototype.goToCustomerForm = function () {
                this.$location.path('/ql-toa-hang/khach-hang/tao');
            };
            CustomerManagementController.prototype.goToCustomerEditForm = function (event, customerId) {
                event.stopPropagation();
                this.$location.path("/ql-toa-hang/khach-hang/sua/" + customerId);
            };
            CustomerManagementController.prototype.proccessFastPayment = function (event, customerId) {
                var _this = this;
                event.stopPropagation();
                var confirmDialog = this.$window.confirm('Bạn có muốn thanh toán nhanh cho khách hàng này?');
                if (confirmDialog) {
                    this.customerService.proccessFastPayment(customerId, function (data) {
                        _this.initCustomerList();
                    }, function (error) {
                        _this.errorMessage = 'Thanh toán nhanh lỗi!';
                        _this.$timeout(function () {
                            _this.errorMessage = '';
                        }, 8000);
                    });
            ...
            CustomerManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            CustomerManagementController.prototype.updateNewPayment = function () {
                this.mainHelper.onCurrencyPropertyChanged(this.currentCustomer, 'newPayment', "newPayment" + formatSuffix);
            };
            CustomerManagementController.prototype.hasSelectedCustomer = function () {
                if (!this.customerListView)
                    return false;
                return this.customerListView.some(function (customer) { return customer.isChecked; });
            };
            return CustomerManagementController;
        }());
...
(function (Clarity) {
    ...
    (function (Controller) {
        var service = Clarity.Service;
        var helper = Clarity.Helper;
        var formatSufix = 'Formatted';
        var WagonManagementController = (function () {
            function WagonManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                ...
                $scope.$watch('viewModel.searchText', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.currentPage === 0 ? _this.fetchWagonListPerPage() : (function () { _this.currentPage = 0; })();
                    _this.fetchNumOfPages();
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.fetchWagonListPerPage();
                });
                $scope.$watch('viewModel.pageSize', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
            ...
            WagonManagementController.prototype.initWagon = function () {
                ...
                if (wagonId) {
                    ...
                    if (this.$location.path() === '/ql-toa-hang/toa-hang/tao') {
                        this.currentWagon = new Clarity.Model.WagonModel();
                        this.initTruckList();
                        this.initEmployeeList();
                        this.initCustomerList();
            ...
            WagonManagementController.prototype.initCurrentWagon = function (wagonId) {
                var _this = this;
                if (this.currentWagon == null) {
                    this.$rootScope.showSpinner();
                    this.wagonService.getById(wagonId, function (data) {
                        _this.currentWagon = data;
                        _this.initFormattedCurrencyForWagon();
                        _this.$rootScope.hideSpinner();
                        _this.initTruckList();
                        _this.initEmployeeList();
                        _this.initCustomerList();
                        _this.initDepartureAndDestinationList();
                    }, null);
                }
            };
            WagonManagementController.prototype.initWagonList = function () {
                this.currentPage = 0;
                this.fetchWagonListPerPage();
                this.fetchNumOfPages();
            };
            WagonManagementController.prototype.fetchWagonListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.wagonService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.wagonList = results;
                    _this.mapToWagonListView();
                    _this.isLoading = false;
                }, null);
            };
            WagonManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.wagonService.getNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
            WagonManagementController.prototype.mapToWagonListView = function () {
                var _this = this;
                this.wagonListView = this.wagonList.map(function (wagon) {
                    var wagonView = new Clarity.Model.WagonViewModel();
                    ...
                    var totalPayment = wagon.paymentOfTruck + wagon.paymentOfRepairing + wagon.paymentOfOil + wagon.paymentOfLuong +
                        wagon.paymentOfService + wagon.paymentOfHangVe - wagon.paymentOf10Percent;
                    wagonView.totalPayment = _this.$filter('currency')(totalPayment, '', 0).trim();
                    return wagonView;
                });
            };
            WagonManagementController.prototype.initTruckList = function () {
                var _this = this;
                this.truckService.getAllCurtail(function (results) {
                    _this.$rootScope.truckList = results;
                    _this.truckList = _this.$rootScope.truckList;
                }, null);
            };
            WagonManagementController.prototype.initEmployeeList = function () {
                var _this = this;
                this.employeeService.getAllCurtail(function (results) {
                    _this.employeeList = results;
                }, null);
            };
            WagonManagementController.prototype.initCustomerList = function () {
                var _this = this;
                this.customerService.getAllCurtail(function (results) {
                    _this.customerList = results;
                }, null);
            };
            WagonManagementController.prototype.initDepartureAndDestinationList = function () {
                var _this = this;
                this.wagonService.getAllDepartureAndDestination(function (results) {
                    _this.departureList = results.departures;
                    _this.destinationList = results.destinations;
                }, null);
            };
            WagonManagementController.prototype.selectAllWagonsOnPage = function () {
                var _this = this;
                this.wagonListView.map(function (wagon) { return wagon.isChecked = _this.isCheckedAll; });
            };
            WagonManagementController.prototype.removeWagons = function () {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa những toa hàng đã chọn?');
                if (confirmDialog) {
                    for (var i = 0; i < this.wagonListView.length; i++) {
                        var wagon = this.wagonListView[i];
                        if (wagon.isChecked) {
                            this.wagonService.deleteEntity(wagon, function (data) {
                                _this.initWagonList();
                            }, null);
                        }
                    }
            ...
            WagonManagementController.prototype.removeWagonInDetail = function (wagon) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa toa hàng này?');
                if (confirmDialog) {
                    this.wagonService.deleteEntity(wagon, function (data) {
                        _this.$location.path('/ql-toa-hang/toa-hang');
                    }, null);
                }
            };
            WagonManagementController.prototype.createWagon = function (wagon) {
                var _this = this;
                this.isSubmitting = true;
                this.wagonService.create(wagon, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/toa-hang');
                }, null);
            };
            WagonManagementController.prototype.updateWagon = function (wagon) {
                var _this = this;
                this.isSubmitting = true;
                this.wagonService.update(wagon, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/toa-hang');
                }, null);
            };
            WagonManagementController.prototype.createWagonSettlement = function (wagon) {
                if (wagon.wagonSettlements == null) {
                    wagon.wagonSettlements = [];
                }
                var wagonSettlement = new Clarity.Model.WagonSettlementModel();
                wagon.wagonSettlements.push(wagonSettlement);
            };
            WagonManagementController.prototype.deleteWagonSettlement = function (index) {
            ...
            WagonManagementController.prototype.goToWagonForm = function () {
                this.$location.path('/ql-toa-hang/toa-hang/tao');
            };
            WagonManagementController.prototype.goToWagonEditForm = function (event, wagonId) {
                event.stopPropagation();
                this.$location.path('/ql-toa-hang/toa-hang/sua/' + wagonId);
            };
            WagonManagementController.prototype.updateWagonSettlementPayment = function (wagonSettlement) {
                if (wagonSettlement && wagonSettlement.unitPrice && wagonSettlement.quantity) {
                    var totalAmount = wagonSettlement.quantity * wagonSettlement.unitPrice;
            ...
            WagonManagementController.prototype.initFormattedCurrencyForWagon = function () {
                var _this = this;
                if (this.currentWagon) {
                    ...
                    if (this.currentWagon.wagonSettlements && this.currentWagon.wagonSettlements.length > 0) {
                        var wagonSettelments = this.currentWagon.wagonSettlements;
                        var wagonSettlementFormattedProperties_1 = ['unitPrice', 'phiPhatSinh', 'payment'];
                        wagonSettelments.forEach(function (wagonSettelment) {
                            _this.mainHelper.initCurrencyFormattedProperty(wagonSettelment, wagonSettlementFormattedProperties_1, formatSufix);
                        });
                    }
                    this.totalAmountWagonSettlements = this.calculateTotalAmountWagonSettlements(this.currentWagon);
                }
            };
            WagonManagementController.prototype.formatCurrency = function (object, propertyName, formattedPropertyName) {
                this.mainHelper.onCurrencyPropertyChanged(object, propertyName, formattedPropertyName);
            };
            WagonManagementController.prototype.onChangeWagonSettlement = function (wagonSettlement, propertyName, formattedPropertyName) {
            ...
            WagonManagementController.prototype.calculateTotalAmountWagonSettlements = function (wagon) {
                var totalAmount = 0;
                if (wagon && wagon.wagonSettlements && wagon.wagonSettlements.length > 0) {
                    wagon.wagonSettlements.forEach(function (wagonSettlement) {
                        totalAmount += wagonSettlement.quantity * wagonSettlement.unitPrice;
                    });
                }
                return totalAmount;
            };
            WagonManagementController.prototype.getLicensePlate = function (truckId) {
                return this.mainHelper.getPropertyValue(this.truckList, 'id', truckId, 'licensePlate');
            };
            WagonManagementController.prototype.getEmployeeName = function (employeeId) {
                return this.mainHelper.getPropertyValue(this.employeeList, 'id', employeeId, 'fullName');
            };
            WagonManagementController.prototype.getCustomerName = function (customerId) {
                return this.mainHelper.getPropertyValue(this.customerList, 'id', customerId, 'fullName');
            };
            // wagonCode = NgayThanhToan_SoXe
            WagonManagementController.prototype.updateWagonCode = function () {
            ...
            WagonManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            WagonManagementController.prototype.hasSelectedWagon = function () {
                if (!this.wagonListView)
                    return false;
                return this.wagonListView.some(function (wagon) { return wagon.isChecked; });
            };
            return WagonManagementController;
        }());
        Controller.WagonManagementController = WagonManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var helper = Clarity.Helper;
        var formatSuffix = 'Formatted';
        var WagonSettlementManagementController = (function () {
            function WagonSettlementManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            WagonSettlementManagementController.prototype.initWagonSettlement = function () {
                var _this = this;
                ...
                if (wagonSettlementId) {
                    if (this.$location.path() === '/ql-toa-hang/quyet-toan/' + wagonSettlementId) {
                        this.$rootScope.showSpinner();
                        this.wagonSettlementService.getById(wagonSettlementId, function (data) {
                            _this.currentWagonSettlement = data;
                            _this.initPaymentList(_this.currentWagonSettlement.code);
                        }, null);
                    }
                        ...
                        if (this.currentWagonSettlement == null) {
                            ...
                            this.wagonSettlementService.getById(wagonSettlementId, function (data) {
                                ...
                                _this.$rootScope.hideSpinner();
                                // init data
                                _this.todayFormat = new Date().toLocaleString();
                                _this.mainHelper.initCurrencyFormattedProperty(_this.currentWagonSettlement, ['unitPrice'], formatSuffix);
                                _this.currentWagonSettlement.paymentDate = '';
                                _this.currentWagonSettlement.paymentFormatted = '';
                            }, null);
                        }
                    }
                }
            ...
            WagonSettlementManagementController.prototype.initWagonSettlementList = function () {
                var _this = this;
                this.isLoading = true;
                this.wagonSettlementService.getAll(function (results) {
                    _this.wagonSettlementList = results;
                    _this.wagonSettlementList.sort(function (a, b) {
                        return b.id - a.id;
                    });
                    _this.refreshWagonSettlementListView();
                    _this.isLoading = false;
                }, null);
            };
            WagonSettlementManagementController.prototype.mapToWagonSettlementListView = function () {
                var _this = this;
                this.wagonSettlementListView = this.wagonSettlementList.map(function (wagonSettlement) {
                    var wagonSettlementView = new Clarity.Model.WagonSettlementViewModel();
                    wagonSettlementView.id = wagonSettlement.id;
                    wagonSettlementView.wagonCode = _this.getWagonCode(wagonSettlement.wagonId);
                    wagonSettlementView.departDate = _this.getDepartDate(wagonSettlement.wagonId);
                    wagonSettlementView.customerName = _this.getCustomerName(wagonSettlement.customerId);
                    wagonSettlementView.totalAmount = _this.mainHelper.formatCurrency(wagonSettlement.quantity * wagonSettlement.unitPrice + wagonSettlement.phiPhatSinh);
                    wagonSettlementView.phiPhatSinh = _this.mainHelper.formatCurrency(wagonSettlement.phiPhatSinh);
                    wagonSettlementView.payment = _this.mainHelper.formatCurrency(wagonSettlement.payment);
                    wagonSettlementView.paymentRemain = _this.mainHelper.formatCurrency(wagonSettlement.paymentRemain);
                    wagonSettlementView.paymentStatus = wagonSettlement.paymentStatus;
                    return wagonSettlementView;
                });
            };
            WagonSettlementManagementController.prototype.refreshWagonSettlementListView = function () {
                if (this.$location.path() === '/ql-toa-hang/quyet-toan') {
            ...
            WagonSettlementManagementController.prototype.initCustomerList = function () {
                var _this = this;
                this.customerService.getAll(function (results) {
                    _this.customerList = results;
                    _this.refreshWagonSettlementListView();
                }, null);
            };
            WagonSettlementManagementController.prototype.initWagonList = function () {
                var _this = this;
                this.wagonService.getAll(function (results) {
                    _this.wagonList = results;
                    _this.refreshWagonSettlementListView();
                }, null);
            };
            WagonSettlementManagementController.prototype.initPaymentList = function (code) {
                var _this = this;
                this.paymentService.getByWagonSettlementCode(code, function (data) {
                    _this.paymentList = data;
                    _this.$rootScope.hideSpinner();
                }, null);
            };
            WagonSettlementManagementController.prototype.updateWagonSettlement = function (customerOrder) {
                var _this = this;
                this.isSubmitting = true;
                this.wagonSettlementService.update(customerOrder, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-toa-hang/quyet-toan');
                }, null);
            };
            WagonSettlementManagementController.prototype.initPagination = function () {
                this.currentPage = 1;
            ...
            WagonSettlementManagementController.prototype.getWagonSettlementListOnPage = function () {
            ...
            WagonSettlementManagementController.prototype.updateNewPayment = function () {
                this.mainHelper.onCurrencyPropertyChanged(this.currentWagonSettlement, 'newPayment', "newPayment" + formatSuffix);
            };
            WagonSettlementManagementController.prototype.getCustomerName = function (customerId) {
                if (customerId) {
                    return this.mainHelper.getPropertyValue(this.customerList, 'id', customerId.toString(), 'fullName');
                }
            };
            WagonSettlementManagementController.prototype.getWagonCode = function (wagonId) {
                if (wagonId) {
                    return this.mainHelper.getPropertyValue(this.wagonList, 'id', wagonId.toString(), 'code');
                }
            };
            WagonSettlementManagementController.prototype.getDepartDate = function (wagonId) {
                if (wagonId) {
                    return this.mainHelper.getPropertyValue(this.wagonList, 'id', wagonId.toString(), 'departDate');
                }
            };
            WagonSettlementManagementController.prototype.getPaymentDate = function (wagonId) {
                if (wagonId) {
                    return this.mainHelper.getPropertyValue(this.wagonList, 'id', wagonId.toString(), 'paymentDate');
                }
            };
            WagonSettlementManagementController.prototype.goToWagonSettlementEditForm = function (event, wagonSettlementId) {
                event.stopPropagation();
                this.$location.path('/ql-toa-hang/quyet-toan/sua/' + wagonSettlementId);
            };
            WagonSettlementManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            return WagonSettlementManagementController;
        }());
        Controller.WagonSettlementManagementController = WagonSettlementManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Controller) {
        var service = Clarity.Service;
        var model = Clarity.Model;
        var ReportManagementController = (function () {
            function ReportManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            ReportManagementController.prototype.initCustomerList = function () {
                var _this = this;
                this.customerService.getAllCurtail(function (results) {
                    _this.customerList = results;
                }, null);
            };
            ReportManagementController.prototype.exportTruck = function () {
                var _this = this;
                this.isExportLoading = true;
                this.exportService.exportToExcel({ type: model.ExportType.Truck }, function (data) {
            ...
            ReportManagementController.prototype.exportEmployee = function () {
                var _this = this;
                this.isExportLoading = true;
                this.exportService.exportToExcel({ type: model.ExportType.Employee }, function (data) {
                    _this.isExportLoading = false;
                    window.location.href = '/output/' + data['fileName'];
                }, function () {
                    _this.isExportLoading = false;
            ...
            ReportManagementController.prototype.exportCustomer = function () {
                var _this = this;
                this.isExportLoading = true;
                var selectedIds = this.customerReport.isCheckedAll
                    ? this.customerList.map(function (_a) {
                        var id = _a.id;
                        return id;
                    })
                ...
                this.exportService.exportToExcel(jsonObject, function (data) {
                    _this.isExportLoading = false;
                    window.location.href = '/output/' + data['fileName'];
                }, function () {
                    _this.isExportLoading = false;
            ...
            ReportManagementController.prototype.exportCustomerOrder = function () {
                var _this = this;
                this.isExportLoading = true;
                var jsonObject = {
            ...
            ReportManagementController.prototype.viewWagon = function () {
                var _this = this;
                this.isViewLoading = true;
                this.wagonService.getWagonReportByDate({ fromDate: this.wagonReport.fromDate, toDate: this.wagonReport.toDate }, function (data) {
                    _this.isViewLoading = false;
                    _this.wagonReport.data = data;
                }, null);
            };
            ReportManagementController.prototype.exportWagon = function () {
                var _this = this;
                this.isExportLoading = true;
                var jsonObject = {
            ...
            ReportManagementController.prototype.viewWagonSettlement = function () {
                var _this = this;
                this.isViewLoading = true;
                this.wagonSettlementService.getWagonSettlementReportByDate({ fromDate: this.wagonSettlementReport.fromDate, toDate: this.wagonSettlementReport.toDate }, function (data) {
                    _this.isViewLoading = false;
                    _this.wagonSettlementReport.data = data;
                }, null);
            };
            ReportManagementController.prototype.exportWagonSettlement = function () {
                var _this = this;
                this.isExportLoading = true;
                var jsonObject = {
            ...
            return ReportManagementController;
        }());
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var UserController = (function () {
            function UserController($scope, $rootScope, $http, $location, $window, $filter, $timeout, $routeParams, $cookieStore) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            UserController.prototype.initUser = function () {
                ...
                if (userId) {
                    ...
                    if (this.$location.path() === '/ql-dang-nhap/tao') {
                        this.currentUser = new Clarity.Model.UserModel();
                    }
            ...
            UserController.prototype.initUserList = function () {
                var _this = this;
                this.isLoading = true;
                this.userService.getAll(function (results) {
                    var loginUser = _this.authenticateService.getUser();
                    if (loginUser.role === Clarity.Enum.Role.Admin) {
                        _this.userList = results;
                        _this.userList.sort(function (a, b) {
                            return b.id - a.id;
                        });
                    }
                    else {
                        _this.userList = results.filter(function (user) {
                            return loginUser.id === user.id;
                        });
                    }
                    _this.mapToUserListView();
                    _this.userListViewTmp = _this.userListView;
                    _this.initPagination();
                    _this.isLoading = false;
                }, null);
            };
            UserController.prototype.initCurrentUser = function (userId) {
                var _this = this;
                if (this.currentUser == null) {
                    this.userService.getById(userId, function (data) {
                        _this.currentUser = data;
                        _this.currentUser.repeatPassword = _this.currentUser.password;
                    }, null);
                }
            };
            UserController.prototype.mapToUserListView = function () {
                var _this = this;
                this.userListView = this.userList.map(function (user) {
                    var userView = new Clarity.Model.UserViewModel();
                    userView.id = user.id;
                    ...
                    userView.role = _this.getRoleName(user.role);
                    return userView;
                });
            };
            ...
            UserController.prototype.removeUsers = function () {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa những tài khoản được chọn?');
                if (confirmDialog) {
                    for (var i = 0; i < this.userListView.length; i++) {
                        var user = this.userListView[i];
                        if (user.isChecked) {
                            this.userService.deleteEntity(user, function (data) {
                                _this.initUserList();
                            }, null);
                        }
                    }
            ...
            UserController.prototype.removeUserInDetail = function (user) {
                ...
                if (confirmDialog) {
                    this.userService.deleteEntity(user, function (data) {
                        _this.$location.path('/ql-dang-nhap');
                    }, null);
                }
            };
            UserController.prototype.createUser = function (user) {
                ...
                if (user.password == user.repeatPassword) {
                    this.isSubmitting = true;
                    this.userService.create(user, function (data) {
                        _this.isSubmitting = false;
                        _this.$location.path('/ql-dang-nhap');
                    }, function (error) {
                        _this.isSubmitting = false;
                        _this.errorMessage = 'Tên tài khoản đã tồn tại';
                        _this.$timeout(function () {
                            _this.errorMessage = '';
                        }, 8000);
                    });
            ...
            UserController.prototype.updateUser = function (user) {
                ...
                if (user.password == user.repeatPassword) {
                    this.isSubmitting = true;
                    this.userService.update(user, function (data) {
                        _this.isSubmitting = false;
                        _this.$location.path('/ql-dang-nhap');
                    }, null);
                }
            ...
            UserController.prototype.goToUserForm = function () {
                this.$location.path('/ql-dang-nhap/tao');
            };
            UserController.prototype.goToUserEditForm = function (event, userId) {
                event.stopPropagation();
                this.$location.path("/ql-dang-nhap/sua/" + userId);
            };
            UserController.prototype.getRoleName = function (role) {
                var availableRoles = ['Admin', "Quản lý toa hàng", "Quản lý garage", "Quản lý báo cáo", "Thông tin phương tiện"];
                if (role >= availableRoles.length)
                    return '';
                return availableRoles[role];
            };
            UserController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            UserController.prototype.isAdminRole = function () {
                return this.authenticateService.getUserRole() == Clarity.Enum.Role.Admin;
            };
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var helper = Clarity.Helper;
        var formatSuffix = 'Formatted';
        var ProductManagementController = (function () {
            function ProductManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $timeout, $routeParams) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                ...
                $scope.$watch('viewModel.searchText', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.currentPage === 0 ? _this.fetchProductListPerPage() : (function () { _this.currentPage = 0; })();
                    _this.fetchNumOfPages();
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.fetchProductListPerPage();
                });
                $scope.$watch('viewModel.pageSize', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
            ...
            ProductManagementController.prototype.initProduct = function () {
                ...
                if (productId) {
                    ...
                    if (this.$location.path() === '/ql-garage/san-pham/tao') {
                        this.currentProduct = new Clarity.Model.ProductModel();
                    }
            ...
            ProductManagementController.prototype.initProductList = function () {
                this.fetchProductListPerPage();
                this.fetchNumOfPages();
            };
            ProductManagementController.prototype.fetchProductListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.productService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.productList = results;
                    _this.isLoading = false;
                });
            };
            ProductManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.productService.getNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
            ProductManagementController.prototype.initCurrentProduct = function (productId) {
                var _this = this;
                if (this.currentProduct == null) {
                    this.productService.getById(productId, function (data) {
                        _this.currentProduct = data;
                        _this.currentProduct.priceFormatted = _this.mainHelper.formatCurrency(data.price);
                        _this.currentProduct.inputPriceFormatted = _this.mainHelper.formatCurrency(data.inputPrice);
                    }, null);
                }
            };
            ProductManagementController.prototype.selectAllProductsOnPage = function () {
                var _this = this;
                this.productList.map(function (product) { return product.isChecked = _this.isCheckedAll; });
            };
            ProductManagementController.prototype.removeProducts = function () {
                var _this = this;
                ...
                if (confirmDialog) {
                    for (var i = 0; i < this.productList.length; i++) {
                        ...
                        if (product.isChecked) {
                            this.productService.deleteEntity(product, function (data) {
                                _this.initProductList();
                            }, function () { });
                        }
                    }
            ...
            ProductManagementController.prototype.removeProductInDetail = function (product) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa sản phẩm này?');
                if (confirmDialog) {
                    this.productService.deleteEntity(product, function (data) {
                        _this.$location.path('/ql-garage/san-pham');
                    }, null);
                }
            };
            ProductManagementController.prototype.createProduct = function (product) {
                var _this = this;
                this.isSubmitting = true;
                this.productService.create(product, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-garage/san-pham');
                }, function (error) {
                    _this.isSubmitting = false;
            ...
            ProductManagementController.prototype.updateProduct = function (product) {
                var _this = this;
                this.isSubmitting = true;
                this.productService.update(product, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-garage/san-pham');
                }, null);
            };
            ProductManagementController.prototype.goToProductForm = function () {
                this.$location.path('/ql-garage/san-pham/tao');
            };
            ProductManagementController.prototype.goToProductEditForm = function (event, productId) {
                event.stopPropagation();
                this.$location.path("/ql-garage/san-pham/sua/" + productId);
            };
            ProductManagementController.prototype.formatCurrency = function (product, propertyName) {
                this.mainHelper.onCurrencyPropertyChanged(product, propertyName, "" + propertyName + formatSuffix);
            };
            ProductManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            ProductManagementController.prototype.hasSelectedProduct = function () {
                if (!this.productList)
                    return false;
                return this.productList.some(function (product) { return product.isChecked; });
            };
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var helper = Clarity.Helper;
        var formatSuffix = 'Formatted';
        var OrderManagementController = (function () {
            function OrderManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $routeParams) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                ...
                $scope.$watch('viewModel.searchText', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    if (_this.$location.path() === '/ql-garage/ban-hang') {
                        _this.currentPage === 0 ? _this.fetchOrderListPerPage() : (function () { _this.currentPage = 0; })();
                        _this.fetchNumOfPages();
                    }
                    else if (_this.$location.path() === '/ql-garage/ban-hang/da-xoa') {
                        _this.currentPage === 0 ? _this.fetchDeletedOrderListPerPage() : (function () { _this.currentPage = 0; })();
                        _this.fetchDeletedOrderNumOfPages();
                    }
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    if (_this.$location.path() === '/ql-garage/ban-hang') {
                        _this.fetchOrderListPerPage();
                    }
                    else if (_this.$location.path() === '/ql-garage/ban-hang/da-xoa') {
                        _this.fetchDeletedOrderListPerPage();
                    }
                });
                $scope.$watch('viewModel.pageSize', function (newValue, oldValue) {
                    if (newValue === oldValue)
                    ...
                    if (_this.$location.path() === '/ql-garage/ban-hang') {
                        ...
                        _this.initDeletedOrderList();
                    }
                });
            }
            OrderManagementController.prototype.initOrder = function () {
                var _this = this;
                ...
                if (orderId) {
                    if (this.$location.path() === '/ql-garage/ban-hang/' + orderId ||
                        ...
                        this.orderService.getById(orderId, function (data) {
                            _this.currentOrder = data;
                            _this.initProductList();
                        }, null);
                    }
                        ...
                        if (this.currentOrder == null) {
                            this.orderService.getById(orderId, function (data) {
                                _this.currentOrder = data;
                                _this.originOrderDetails = angular.copy(_this.currentOrder.orderDetails);
                                _this.initFormatPriceForOrderDetails(_this.currentOrder);
                                _this.initInventoryViewList();
                            }, null);
                        }
                    }
                }
                    ...
                    if (this.$location.path() === '/ql-garage/ban-hang/tao') {
                        ...
                        this.currentOrder = new Clarity.Model.OrderModel();
            ...
            OrderManagementController.prototype.initOrderList = function () {
                this.fetchOrderListPerPage();
                this.fetchNumOfPages();
            };
            OrderManagementController.prototype.initDeletedOrderList = function () {
                this.fetchDeletedOrderListPerPage();
                this.fetchDeletedOrderNumOfPages();
            };
            OrderManagementController.prototype.fetchOrderListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.orderService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.initOrderListAfterCallAsync(results);
                });
            };
            OrderManagementController.prototype.fetchDeletedOrderListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.orderService.getDeletedOrdersPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.initOrderListAfterCallAsync(results);
                }, null);
            };
            OrderManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.orderService.getNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
            OrderManagementController.prototype.fetchDeletedOrderNumOfPages = function () {
                var _this = this;
                this.orderService.getDeletedOrdersNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                }, null);
            };
            OrderManagementController.prototype.initOrderListAfterCallAsync = function (results) {
                this.orderList = results;
                this.mapToOrderListView();
                this.isLoading = false;
            };
            OrderManagementController.prototype.mapToOrderListView = function () {
                var _this = this;
                this.orderListView = this.orderList.map(function (order) {
                    var orderView = new Clarity.Model.OrderViewModel();
                    orderView.id = order.id;
                    orderView.licensePlate = order.licensePlate;
                    orderView.customerName = order.customerName;
                    orderView.totalAmount = _this.mainHelper.formatCurrency(order.totalAmount);
            ...
            OrderManagementController.prototype.initInventoryViewList = function () {
                var _this = this;
                this.productService.getAll(function (results) {
                    _this.productList = results;
                    _this.inventoryService.getAll(function (results) {
                        _this.inventoryViewList = [];
                        results.map(function (inventory) {
                            var inventoryView = new Clarity.Model.InventoryViewModel();
                            inventoryView.id = inventory.id;
                            inventoryView.productId = inventory.productId;
                            inventoryView.productName = _this.getProductById(inventory.productId).name;
                            inventoryView.latestPrice = inventory.latestPrice;
                            // inventoryView.quantity = inventory.quantity;
                            inventoryView.quantity = _this.initInventoryQuantity(inventory, _this.currentOrder);
                            _this.inventoryViewList.push(inventoryView);
                        });
                        // init max quantity for order detail
                        _this.initMaxQuantityForOrderDetails(_this.currentOrder);
                    }, null);
                }, null);
            };
            OrderManagementController.prototype.initProductList = function () {
                var _this = this;
                this.productService.getAll(function (results) {
                    _this.productList = results;
                }, null);
            };
            OrderManagementController.prototype.initInventoryQuantity = function (inventory, order) {
                if (order && order.orderDetails && order.orderDetails.length > 0) {
                    return order.orderDetails.reduce(function (acc, orderDeail) {
            ...
            OrderManagementController.prototype.initFormatPriceForOrderDetails = function (order) {
                if (order && order.orderDetails && order.orderDetails.length > 0) {
            ...
            OrderManagementController.prototype.initMaxQuantityForOrderDetails = function (order) {
                if (order && order.orderDetails && order.orderDetails.length > 0) {
                    for (var _i = 0, _a = order.orderDetails; _i < _a.length; _i++) {
                        var orderDetail = _a[_i];
            ...
            OrderManagementController.prototype.selectAllProductsOnPage = function () {
                var _this = this;
                this.orderListView.map(function (order) { return order.isChecked = _this.isCheckedAll; });
            };
            OrderManagementController.prototype.removeOrders = function () {
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa những đơn hàng được chọn?');
                if (confirmDialog) {
                    var selectedOrders = this.orderListView.filter(function (order) { return order.isChecked; });
                    this.deleteOrdersSync(selectedOrders);
                }
            };
            OrderManagementController.prototype.deleteOrdersSync = function (orders) {
                var _this = this;
                if (orders.length === 0) {
                    this.initOrderList();
                    return;
                }
                this.orderService.deleteEntity(orders[0], function (data) {
                    var newOrders = orders.slice(1, orders.length);
                    _this.deleteOrdersSync(newOrders);
                }, null);
            };
            OrderManagementController.prototype.removeOrderInDetail = function (order) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa đơn hàng này?');
                if (confirmDialog) {
                    this.orderService.deleteEntity(order, function (data) {
                        _this.$location.path('/ql-garage/ban-hang');
                    }, null);
                }
            };
            OrderManagementController.prototype.restoreOrder = function (orderViewModel) {
                var _this = this;
                orderViewModel.status = true;
                this.orderService.changeOrderStatus(orderViewModel, function (data) {
                    _this.initDeletedOrderList();
                }, null);
            };
            OrderManagementController.prototype.createOrder = function (order) {
                var _this = this;
                this.isSubmitting = true;
                this.orderService.create(order, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-garage/ban-hang');
                }, null);
            };
            OrderManagementController.prototype.updateOrder = function (product) {
                var _this = this;
                this.isSubmitting = true;
                this.orderService.update(product, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-garage/ban-hang');
                }, null);
            };
            OrderManagementController.prototype.goToOrderForm = function () {
                this.$location.path('/ql-garage/ban-hang/tao');
            };
            OrderManagementController.prototype.goToOrderEditForm = function (event, orderId) {
                event.stopPropagation();
                this.$location.path("/ql-garage/ban-hang/sua/" + orderId);
            };
            OrderManagementController.prototype.goToDeletedOrders = function () {
                this.$location.path('/ql-garage/ban-hang/da-xoa');
            };
            OrderManagementController.prototype.goToOrderPrintPage = function (event, orderViewModel) {
                event.stopPropagation();
                this.$window.open('#/ql-garage/ban-hang/in/' + orderViewModel.id);
            };
            OrderManagementController.prototype.addOrderDetail = function () {
                var orderDetail = new Clarity.Model.OrderDetailModel();
                this.currentOrder.orderDetails.push(orderDetail);
            };
            OrderManagementController.prototype.deleteOrderDetail = function (index) {
                this.currentOrder.orderDetails.splice(index, 1);
                this.updateTotalAmount();
                this.updateNote();
            };
            OrderManagementController.prototype.getProductById = function (id) {
            ...
            OrderManagementController.prototype.getInventoryViewByProductId = function (id) {
                if (this.inventoryViewList && this.inventoryViewList.length > 0) {
                    for (var _i = 0, _a = this.inventoryViewList; _i < _a.length; _i++) {
                        var inventory = _a[_i];
            ...
            OrderManagementController.prototype.onInventoryViewChanged = function (orderDetail, index) {
            ...
            OrderManagementController.prototype.shouldOrderDetailSetDefault = function (orderDetail, index) {
                if (!orderDetail.id) {
                    return true;
                }
                if (this.originOrderDetails == null) {
                    return true;
                }
                if (this.originOrderDetails[index] == null) {
                    return true;
                }
                return false;
            };
            OrderManagementController.prototype.onQuantityOrderDetailChanged = function () {
                this.updateTotalAmount();
                this.updateNote();
            };
            OrderManagementController.prototype.updateTotalAmount = function () {
                this.currentOrder.totalAmount = 0;
                if (this.currentOrder && this.currentOrder.orderDetails && this.currentOrder.orderDetails.length) {
                    for (var _i = 0, _a = this.currentOrder.orderDetails; _i < _a.length; _i++) {
                        var orderDetail = _a[_i];
                        this.currentOrder.totalAmount += orderDetail.price * orderDetail.quantity;
                    }
                }
            };
            OrderManagementController.prototype.updateNote = function () {
            ...
            OrderManagementController.prototype.setFormatedCurencyForOrderDetail = function (orderDetail) {
                this.mainHelper.onCurrencyPropertyChanged(orderDetail, 'price', "price" + formatSuffix);
                this.updateTotalAmount();
                this.updateNote();
            };
            OrderManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            OrderManagementController.prototype.exportOrder = function () {
                var _this = this;
                this.isExportLoading = true;
                var jsonObject = {
                    type: Clarity.Model.ExportType.GarageOrder,
                    fromDate: this.fromDate,
                    toDate: this.toDate
                };
                this.exportService.exportToExcel(jsonObject, function (data) {
            ...
            OrderManagementController.prototype.hasSelectedOrder = function () {
                if (!this.orderListView)
                    return false;
                return this.orderListView.some(function (order) { return order.isChecked; });
            };
            OrderManagementController.prototype.filterInventoryView = function (currentOrder, index) {
                return function (value) {
                    if (currentOrder && currentOrder.orderDetails && currentOrder.orderDetails.length > 0) {
                        var selectedOrderDetails = currentOrder.orderDetails.filter(function (orderDetail, i) {
                            return i !== index;
                        });
                        if (selectedOrderDetails && selectedOrderDetails.length === 0) {
                            return true;
                        }
                        return !selectedOrderDetails.some(function (orderDetail) { return value.productId == orderDetail.productId; });
                    }
                    return true;
                };
            };
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var helper = Clarity.Helper;
        var formatSuffix = 'Formatted';
        var InputOrderManagementController = (function () {
            function InputOrderManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $routeParams) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                ...
                $scope.$watch('viewModel.searchText', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.currentPage === 0 ? _this.fetchInputOrderListPerPage() : (function () { _this.currentPage = 0; })();
                    _this.fetchNumOfPages();
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.fetchInputOrderListPerPage();
                });
                $scope.$watch('viewModel.pageSize', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.clearSearchText();
                    _this.initInputOrderList();
                });
            }
            InputOrderManagementController.prototype.initInputOrder = function () {
                ...
                if (inputOrderId) {
                    ...
                    if (this.$location.path() === '/ql-garage/nhap-kho/tao') {
                        this.initProductList();
                        this.todayFormat = new Date().toLocaleString();
                        this.currentInputOrder = new Clarity.Model.InputOrderModel();
            ...
            InputOrderManagementController.prototype.initCurrentInputOrder = function (inputOrderId) {
                var _this = this;
                if (this.currentInputOrder == null) {
                    this.inputOrderService.getById(inputOrderId, function (data) {
                        _this.currentInputOrder = data;
                        _this.initFormatPriceForProductInputs(_this.currentInputOrder);
                        _this.initProductList();
                    }, null);
                }
            };
            InputOrderManagementController.prototype.initInputOrderList = function () {
                this.fetchInputOrderListPerPage();
                this.fetchNumOfPages();
            };
            InputOrderManagementController.prototype.fetchInputOrderListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.inputOrderService.getPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.inputOrderList = results;
                    _this.mapToInputOrderListView();
                    _this.isLoading = false;
                });
            };
            InputOrderManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.inputOrderService.getNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
            InputOrderManagementController.prototype.mapToInputOrderListView = function () {
                var _this = this;
                this.inputOrderListView = this.inputOrderList.map(function (inputOrder) {
                    var inputOrderView = new Clarity.Model.InputOrderViewModel();
                    ...
                    inputOrderView.totalAmount = _this.mainHelper.formatCurrency(inputOrder.totalAmount);
                    inputOrderView.date = inputOrder.date;
                    return inputOrderView;
                });
            };
            InputOrderManagementController.prototype.initProductList = function () {
                var _this = this;
                this.productService.getAll(function (results) {
                    _this.productList = results;
                    _this.productNameList = _this.productList.map(function (product) {
                        return product.name;
                    });
                }, null);
            };
            InputOrderManagementController.prototype.initFormatPriceForProductInputs = function (inputOrder) {
                if (inputOrder && inputOrder.productInputs && inputOrder.productInputs.length > 0) {
                    for (var _i = 0, _a = inputOrder.productInputs; _i < _a.length; _i++) {
                        var productInput = _a[_i];
                        this.mainHelper.initCurrencyFormattedProperty(productInput, ['inputPrice', 'salePrice'], formatSuffix);
                    }
                }
            };
            InputOrderManagementController.prototype.selectAllInputOrdersOnPage = function () {
                var _this = this;
                this.inputOrderListView.map(function (inputOrder) { return inputOrder.isChecked = _this.isCheckedAll; });
            };
            InputOrderManagementController.prototype.removeOrders = function () {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa những kho hàng được chọn?');
                if (confirmDialog) {
                    for (var i = 0; i < this.inputOrderListView.length; i++) {
                        var product = this.inputOrderListView[i];
                        if (product.isChecked) {
                            this.inputOrderService.deleteEntity(product, function (data) {
                                _this.initInputOrderList();
                            }, function () { });
                        }
                    }
            ...
            InputOrderManagementController.prototype.removeInputOrderInDetail = function (inputOrder) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa kho hàng này?');
                if (confirmDialog) {
                    this.inputOrderService.deleteEntity(inputOrder, function (data) {
                        _this.$location.path('/ql-garage/nhap-kho');
                    }, null);
                }
            };
            InputOrderManagementController.prototype.createInputOrder = function (inputOrder) {
                var _this = this;
                this.isSubmitting = true;
                this.inputOrderService.create(inputOrder, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-garage/nhap-kho');
                }, null);
            };
            InputOrderManagementController.prototype.updateInputOrder = function (inputOrder) {
                var _this = this;
                this.isSubmitting = true;
                this.inputOrderService.update(inputOrder, function (data) {
                    _this.isSubmitting = false;
                    _this.$location.path('/ql-garage/nhap-kho');
                }, null);
            };
            InputOrderManagementController.prototype.goToInputOrderForm = function () {
                this.$location.path('/ql-garage/nhap-kho/tao');
            };
            InputOrderManagementController.prototype.goToInputOrderEditForm = function (event, inputOrderId) {
                event.stopPropagation();
                this.$location.path("/ql-garage/nhap-kho/sua/" + inputOrderId);
            };
            InputOrderManagementController.prototype.addProductInput = function () {
                var productInput = new Clarity.Model.ProductInputModel();
                this.currentInputOrder.productInputs.push(productInput);
            };
            InputOrderManagementController.prototype.deleteProductInput = function (index) {
                this.currentInputOrder.productInputs.splice(index, 1);
                this.updateTotalAmount();
            };
            InputOrderManagementController.prototype.getProductById = function (id) {
                if (this.productList && this.productList.length > 0) {
                    for (var _i = 0, _a = this.productList; _i < _a.length; _i++) {
                        var product = _a[_i];
                        if (product.id == id) {
            ...
            InputOrderManagementController.prototype.updateTotalAmount = function () {
                this.currentInputOrder.totalAmount = 0;
                if (this.currentInputOrder && this.currentInputOrder.productInputs && this.currentInputOrder.productInputs.length) {
                    for (var _i = 0, _a = this.currentInputOrder.productInputs; _i < _a.length; _i++) {
                        var productInput = _a[_i];
                        this.currentInputOrder.totalAmount += productInput.inputPrice * productInput.quantity;
                    }
                }
            };
            InputOrderManagementController.prototype.formatCurrency = function (productInput, propertyName) {
                this.mainHelper.onCurrencyPropertyChanged(productInput, propertyName, "" + propertyName + formatSuffix);
                if (propertyName === 'inputPrice') {
                    this.updateTotalAmount();
                }
            };
            InputOrderManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            InputOrderManagementController.prototype.hasSelectedInputOrder = function () {
                if (!this.inputOrderListView)
                    return false;
                return this.inputOrderListView.some(function (wagon) { return wagon.isChecked; });
            };
            InputOrderManagementController.prototype.exportInputOrder = function () {
                var _this = this;
                this.isExportLoading = true;
                var jsonObject = {
                    type: Clarity.Model.ExportType.GarageInputOrder,
                    fromDate: this.fromDate,
                    toDate: this.toDate
                };
                this.exportService.exportToExcel(jsonObject, function (data) {
            ...
            return InputOrderManagementController;
        }());
        Controller.InputOrderManagementController = InputOrderManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var ProductInfoManagementController = (function () {
            function ProductInfoManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $routeParams) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                ...
                $scope.$watch('viewModel.searchText', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.currentPage === 0 ? _this.fetchProductInfoListPerPage() : (function () { _this.currentPage = 0; })();
                    _this.fetchNumOfPages();
                });
                $scope.$watch('viewModel.currentPage', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.fetchProductInfoListPerPage();
                });
                $scope.$watch('viewModel.pageSize', function (newValue, oldValue) {
                    if (newValue === oldValue)
                        return;
                    _this.clearSearchText();
                    _this.initProductInfoList();
                });
            }
            ProductInfoManagementController.prototype.initProduct = function () {
                if (this.$location.path() === '/ql-garage/quan-ly') {
                    this.isLoading = true;
                    this.initProductInfoList();
                }
            };
            ProductInfoManagementController.prototype.initProductInfoList = function () {
                this.fetchProductInfoListPerPage();
                this.fetchNumOfPages();
            };
            ProductInfoManagementController.prototype.fetchProductInfoListPerPage = function () {
                var _this = this;
                this.isLoading = true;
                this.productService.getProductInfoPerPage(this.currentPage, this.pageSize, this.searchText, function (results) {
                    _this.productInfoList = results;
                    _this.orderBy('name', true);
                    _this.isLoading = false;
                }, null);
            };
            ProductInfoManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                this.productService.getNumOfPages(this.pageSize, this.searchText, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
            ...
            ProductInfoManagementController.prototype.mapToProductInfoListView = function () {
                this.productInfoListView = this.mapProductInfoList(this.productInfoList);
            };
            ProductInfoManagementController.prototype.mapProductInfoList = function (productInfoList) {
                var _this = this;
                if (!productInfoList)
                    return [];
                return productInfoList.map(function (productInfo) {
                    var productInfoView = new Clarity.Model.ProductInfoViewModel();
                    productInfoView.id = productInfo.id;
                    productInfoView.name = productInfo.name;
                    productInfoView.sumOfInput = _this.mainHelper.formatCurrency(productInfo.sumOfInput);
                    productInfoView.sumOfSale = _this.mainHelper.formatCurrency(productInfo.sumOfSale);
                    productInfoView.numOfRemain = _this.mainHelper.formatCurrency(productInfo.numOfRemain);
                    productInfoView.sumOfInputTotalAmount = _this.mainHelper.formatCurrency(productInfo.sumOfInputTotalAmount);
                    productInfoView.sumOfSaleTotalAmount = _this.mainHelper.formatCurrency(productInfo.sumOfSaleTotalAmount);
                    productInfoView.profit = _this.mainHelper.formatCurrency(productInfo.profit);
                    return productInfoView;
                });
            };
            ProductInfoManagementController.prototype.orderBy = function (propertyName, isNoReverse) {
            ...
            ProductInfoManagementController.prototype.exportReport = function () {
                var _this = this;
                this.isFullExportLoading = true;
                this.productService.getProductInfoPerPage(0, MAX_PAGE_SIZE, '', function (results) {
                    var productInfoList = _this.$filter('orderBy')(results, 'name', false);
                    _this.exportService.exportGarageToExcel(productInfoList, function (data) {
                        _this.isFullExportLoading = false;
                        window.location.href = '/output/' + data['fileName'];
                        //this.exportService.deleteExcelFile(data['fileName'].split('/')[0], () => { }, null);
                    }, null);
                }, null);
            };
            ProductInfoManagementController.prototype.clearSearchText = function () {
                if (this.searchText != '') {
                    this.searchText = '';
                }
            };
            ProductInfoManagementController.prototype.exportProductInfo = function () {
                var _this = this;
                this.isExportLoading = true;
                var jsonObject = {
                    type: Clarity.Model.ExportType.GarageProductInfoOrder,
                    fromDate: this.fromDate,
                    toDate: this.toDate
                };
                this.exportService.exportToExcel(jsonObject, function (data) {
            ...
            return ProductInfoManagementController;
        }());
        Controller.ProductInfoManagementController = ProductInfoManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Controller) {
        var service = Clarity.Service;
        var helper = Clarity.Helper;
        var TransportationManagementController = (function () {
            function TransportationManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $routeParams) {
                var _this = this;
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
            ...
            TransportationManagementController.prototype.initTransportation = function () {
                this.initTruckList();
            };
            TransportationManagementController.prototype.initOrderList = function () {
                this.fetchOrderListPerPage();
                this.fetchNumOfPages();
            };
            TransportationManagementController.prototype.initTruckList = function () {
                var _this = this;
                this.truckService.getAllCurtail(function (results) {
                    _this.truckList = results;
                }, null);
            };
            TransportationManagementController.prototype.fetchTruckDetail = function () {
                var _this = this;
                this.truckService.getById(this.truckId, function (data) {
                    _this.currentTruck = data;
                }, null);
            };
            TransportationManagementController.prototype.fetchOrderListPerPage = function () {
                var _this = this;
                if (!this.truckId || !this.fromDate || !this.toDate)
                    return;
                this.isLoading = true;
                this.orderService.getTruckInfoPerPage(this.currentPage, this.pageSize, this.searchText, this.getTruckLicensePlate(), this.fromDate, this.toDate, function (results) {
                    _this.initOrderListAfterCallAsync(results);
                });
            };
            TransportationManagementController.prototype.fetchNumOfPages = function () {
                var _this = this;
                if (!this.truckId || !this.fromDate || !this.toDate)
                    return;
                this.orderService.getTruckInfoNumOfPages(this.pageSize, this.searchText, this.getTruckLicensePlate(), this.fromDate, this.toDate, function (results) {
                    _this.currentPage = 0;
                    _this.numOfPages = parseInt(results['pages']);
                });
            };
            TransportationManagementController.prototype.initOrderListAfterCallAsync = function (results) {
                this.orderList = results;
                this.mapToOrderListView();
                this.isLoading = false;
                this.isSubmitting = false;
            };
            TransportationManagementController.prototype.mapToOrderListView = function () {
                this.orderListView = this.orderList.map(function (order) {
                    var orderView = new Clarity.Model.OrderViewModel();
                    orderView.id = order.id;
                    orderView.customerName = order.customerName;
            ...
            TransportationManagementController.prototype.selectAllProductsOnPage = function () {
                var _this = this;
                this.orderListView.map(function (order) { return order.isChecked = _this.isCheckedAll; });
            };
            TransportationManagementController.prototype.clearSearchText = function () {
                this.searchText = '';
            };
            TransportationManagementController.prototype.fetchOrderTruckInfo = function () {
                this.isSubmitting = true;
                this.fetchTruckDetail();
                this.initOrderList();
            };
            ;
            TransportationManagementController.prototype.getTruckLicensePlate = function () {
                var _this = this;
                if (!this.truckList || !this.truckId)
                    return '';
                var selectedTrucks = this.truckList.filter(function (_a) {
                    var id = _a.id;
                    return id == _this.truckId;
                });
                if (!selectedTrucks[0])
                    return '';
                return selectedTrucks[0].licensePlate;
            };
            return TransportationManagementController;
        }());
        Controller.TransportationManagementController = TransportationManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Directive;
    (function (Directive) {
        var ActionButtonForm = (function () {
            function ActionButtonForm() {
                this.templateUrl = 'js/directives/templates/actionButtonForm.html' + '?v=' + VERSION_NUMBER;
                this.restrict = 'E';
                /***
            ...
            ActionButtonForm.prototype.link = function (scope, element, attrs) {
                scope.viewModel = scope;
            };
            ;
            ActionButtonForm.Factory = function () {
        ...
        Directive.ActionButtonForm = ActionButtonForm;
    })(Directive = Clarity.Directive || (Clarity.Directive = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    var Directive;
    (function (Directive) {
        var MAX_VISIBLE_PAGE = 5;
        var CustomPagination = (function () {
            function CustomPagination() {
                this.templateUrl = 'js/directives/templates/customPagination.html' + '?v=' + VERSION_NUMBER;
                this.restrict = 'E';
                this.scope = {
                    numOfPages: '=',
                    currentPage: '=',
            ...
            ;
            CustomPagination.Factory = function () {
                var directive = function () {
