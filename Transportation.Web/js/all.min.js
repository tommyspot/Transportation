...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var OrderManagementController = (function () {
            ...
            OrderManagementController.prototype.removeOrders = function () {
                ...
                if (confirmDialog) {
                    for (var i = 0; i < this.orderList.length; i++) {
                        ...
                        if (product.isChecked) {
                            this.orderService.deleteEntity(product, function (data) {
                                _this.initOrderList();
                            }, function () { });
                        }
                    }
            ...
            OrderManagementController.prototype.createOrder = function (product) {
                var _this = this;
                this.orderService.create(product, function (data) {
                    _this.$location.path('/ql-garage/ban-hang');
                }, null);
            };
