...
(function (Clarity) {
    var Service;
    (function (Service) {
        var ProductInputService = (function (_super) {
            __extends(ProductInputService, _super);
            function ProductInputService($http) {
                _super.call(this, $http);
                this.url = '/api/productInputs';
            }
            ProductInputService.prototype.createList = function (entityList, successCallback, errorCallback) {
                var _this = this;
            ...
            return ProductInputService;
        }(Service.BaseService));
        Service.ProductInputService = ProductInputService;
    })(Service = Clarity.Service || (Clarity.Service = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Controller) {
        var service = Clarity.Service;
        var helper = Clarity.Helper;
        var ProductInputManagementController = (function () {
            function ProductInputManagementController($scope, $rootScope, $http, $location, $window, $filter, $cookieStore, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            ProductInputManagementController.prototype.initProductInput = function () {
                var _this = this;
                this.initProductList();
                var productInputId = this.$routeParams.product_input_id;
                if (productInputId) {
                    if (this.$location.path() === '/ql-garage/nhap-kho/' + productInputId) {
                        this.productInputService.getById(productInputId, function (data) {
                            _this.currentProductInput = data;
                        }, null);
                    }
            ...
            ProductInputManagementController.prototype.initProductInputList = function () {
                var _this = this;
                this.productInputService.getAll(function (results) {
                    _this.productInputList = results;
                    _this.productInputList.sort(function (a, b) {
                        return a.id - b.id;
                    });
                    _this.productInputListTmp = _this.productInputList;
                    _this.initPagination();
                    _this.isLoading = false;
                }, null);
            };
            ProductInputManagementController.prototype.initProductList = function () {
                var _this = this;
                this.productService.getAll(function (results) {
                    _this.productList = results;
                    _this.productList.sort(function (a, b) {
            ...
            ProductInputManagementController.prototype.initPagination = function () {
                this.currentPage = 1;
            ...
            ProductInputManagementController.prototype.getProductInputListOnPage = function () {
            ...
            ProductInputManagementController.prototype.getNumberPage = function () {
                if (this.numOfPages > 0) {
                    return new Array(this.numOfPages);
                }
                return new Array(0);
            };
            ProductInputManagementController.prototype.goToPage = function (pageIndex) {
                this.currentPage = pageIndex;
            };
            ProductInputManagementController.prototype.goToPreviousPage = function () {
                if (this.currentPage > 1) {
                    this.currentPage--;
                    this.goToPage(this.currentPage);
                }
            };
            ProductInputManagementController.prototype.goToNextPage = function () {
                if (this.currentPage < this.numOfPages) {
                    this.currentPage++;
                    this.goToPage(this.currentPage);
                }
            };
            ProductInputManagementController.prototype.selectAllProductsOnPage = function () {
            ...
            ProductInputManagementController.prototype.removeProductInputs = function () {
                var _this = this;
                ...
                if (confirmDialog) {
                    for (var i = 0; i < this.productInputList.length; i++) {
                        ...
                        if (product.isChecked) {
                            this.productInputService.deleteEntity(product, function (data) {
                                _this.initProductInputList();
                            }, function () { });
                        }
                    }
                }
            };
            ProductInputManagementController.prototype.removeProductInputInDetail = function (productInput) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa kho hàng?');
                if (confirmDialog) {
                    this.productInputService.deleteEntity(productInput, function (data) {
                        _this.$location.path('/ql-garage/nhap-kho');
                    }, null);
                }
            };
            ProductInputManagementController.prototype.updateProductInput = function (productInput) {
                var _this = this;
                this.productInputService.update(productInput, function (data) {
                    _this.$location.path('/ql-garage/nhap-kho');
                }, null);
            };
            ProductInputManagementController.prototype.goToProductInputForm = function () {
                this.$location.path('/ql-garage/nhap-kho/tao');
            };
            ProductInputManagementController.prototype.addProductInput = function () {
                var productInput = new Clarity.Model.ProductInputModel();
                this.productInputListForm.push(productInput);
            };
            ProductInputManagementController.prototype.removeProductInput = function (index) {
                if (this.productInputListForm && this.productInputListForm.length > 0) {
                    this.productInputListForm.splice(index, 1);
                }
            };
            ProductInputManagementController.prototype.createProductInputList = function (productInputs) {
                var _this = this;
                this.productInputService.createList(productInputs, function (data) {
                    _this.$location.path('/ql-garage/nhap-kho');
                }, null);
            };
            ProductInputManagementController.prototype.getProductById = function (id) {
                if (this.productList && this.productList.length > 0) {
            ...
            return ProductInputManagementController;
        }());
        Controller.ProductInputManagementController = ProductInputManagementController;
    })(Controller = Clarity.Controller || (Clarity.Controller = {}));
})(Clarity || (Clarity = {}));
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var OrderManagementController = (function () {
                ...
                this.productService.getAll(function (results) {
                    ...
                    _this.inventoryService.getAll(function (results) {
                        ...
                        results.map(function (inventory) {
                            ...
                            inventoryView.productPrice = _this.getProductById(inventory.productId).latestPrice;
            ...
            OrderManagementController.prototype.onQuantityChanged = function (orderDetail) {
                this.currentOrder.totalAmount = this.calculateTotalAmountOrder();
            };
            OrderManagementController.prototype.calculateTotalAmountOrder = function () {
