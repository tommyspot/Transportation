                ...
                if (customerId) {
                    if (this.$location.path() === '/ql-toa-hang/khach-hang/' + customerId) {
                        this.customerService.getById(customerId, function (data) {
                            ...
                            _this.totalOwnedFormated = _this.currentCustomer.totalOwned.toLocaleString();
                            _this.totalPayFormated = _this.currentCustomer.totalPay.toLocaleString();
                            _this.totalDebtFormated = _this.currentCustomer.totalDebt.toLocaleString();
                        }, null);
                    }
