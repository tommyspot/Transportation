                ...
                if (employeeId) {
                    if (this.$location.path() === '/ql-toa-hang/nhan-vien/' + employeeId) {
                        ...
                        if (this.currentEmployee == null) {
                            this.employeeService.getById(employeeId, function (data) {
                                _this.currentEmployee = data;
                                _this.currentEmployee.driverLicenseDate = (data.driverLicenseDate != null && data.driverLicenseDate != null) ? new Date(data.driverLicenseDate) : null;
                                _this.currentEmployee.driverLicenseExpirationDate = (data.driverLicenseExpirationDate != null && data.driverLicenseExpirationDate != null) ? new Date(data.driverLicenseExpirationDate) : null;
                                _this.currentEmployee.startDate = (data.startDate != null && data.startDate != null) ? new Date(data.startDate) : null;
                            }, null);
                        }
                    }
                }
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var TruckManagementController = (function () {
            function TruckManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
                ...
                if (truckId) {
                    if (this.$location.path() === '/ql-toa-hang/xe/' + truckId) {
                        ...
                        if (this.currentTruck == null) {
                            this.truckService.getById(truckId, function (data) {
                                _this.currentTruck = data;
                                _this.currentTruck.startUsingDate = (data.startUsingDate != null && data.startUsingDate != '') ? new Date(data.startUsingDate) : null;
                                _this.currentTruck.buyingDate = (data.buyingDate != null && data.buyingDate != '') ? new Date(data.buyingDate) : null;
                                _this.currentTruck.checkDate = (data.checkDate != null && data.checkDate != '') ? new Date(data.checkDate) : null;
                                _this.currentTruck.insuranceDate = (data.insuranceDate != null && data.insuranceDate != '') ? new Date(data.insuranceDate) : null;
                                _this.monthlyPaymentFormated = data.monthlyPayment.toLocaleString();
                            }, null);
                        }
                    }
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var CustomerOrderManagementController = (function () {
            function CustomerOrderManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
                ...
                if (customerOrderId) {
                    if (this.$location.path() === '/ql-toa-hang/don-hang-cua-khach/' + customerOrderId) {
                        this.customerOrderService.getById(customerOrderId, function (data) {
                            ...
                            _this.applyCustomer(data.customerId);
                            _this.unitPriceFormated = data.unitPrice != 0 ? data.unitPrice.toLocaleString() : '';
                            _this.currentCustomerOrder.departDateFormated = _this.mainHelper.formatDateTimeDDMMYYYY(_this.currentCustomerOrder.departDate);
                            _this.currentCustomerOrder.returnDateFormated = _this.mainHelper.formatDateTimeDDMMYYYY(_this.currentCustomerOrder.returnDate);
                        }, null);
                    }
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var WagonManagementController = (function () {
            function WagonManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
                ...
                if (wagonId) {
                    if (this.$location.path() === '/ql-toa-hang/toa-hang/' + wagonId) {
                        this.wagonService.getById(wagonId, function (data) {
                            ...
                            _this.currentWagon.departDateFormated = _this.mainHelper.formatDateTimeDDMMYYYY(_this.currentWagon.departDate);
                            _this.currentWagon.returnDateFormated = _this.mainHelper.formatDateTimeDDMMYYYY(_this.currentWagon.returnDate);
                        }, null);
                    }
            ...
            WagonManagementController.prototype.initWagonList = function () {
                ...
                this.wagonService.getAll(function (results) {
                    ...
                    for (var i = 0; i < _this.wagonList.length; i++) {
                        ...
                        currentWagon.departDateFormated = _this.mainHelper.formatDateTimeDDMMYYYY(currentWagon.departDate);
                        currentWagon.returnDateFormated = _this.mainHelper.formatDateTimeDDMMYYYY(currentWagon.returnDate);
                    }
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var WagonSettlementManagementController = (function () {
            function WagonSettlementManagementController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
                ...
                if (wagonId) {
                    if (this.$location.path() === '/ql-toa-hang/quyet-toan/' + wagonId) {
                        this.wagonSettlementService.getById(wagonId, function (data) {
                            ...
                            _this.currentWagonSettlement.paymentDate = (data.paymentDate != null && data.paymentDate != '') ? new Date(data.paymentDate) : null;
                            _this.currentWagonSettlement.dateFormated = _this.mainHelper.formatDateTimeDDMMYYYY(_this.currentWagonSettlement.date);
                            _this.currentWagonSettlement.paymentDateFormated = _this.mainHelper.formatDateTimeDDMMYYYY(_this.currentWagonSettlement.paymentDate);
            ...
            WagonSettlementManagementController.prototype.initWagonSettlementList = function () {
                ...
                this.wagonSettlementService.getAll(function (results) {
                    ...
                    _this.formateWagonSettlementDate();
            ...
            WagonSettlementManagementController.prototype.initPaymentList = function (code) {
                ...
                this.paymentService.getByWagonSettlementCode(code, function (data) {
                    ...
                    for (var i = 0; i < _this.paymentList.length; i++) {
                        var payment = _this.paymentList[i];
                        payment.paymentDate = _this.mainHelper.formatDateTimeDDMMYYYY(new Date(payment.paymentDate));
                    }
                }, null);
            };
            ...
            WagonSettlementManagementController.prototype.formateWagonSettlementDate = function () {
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var UserController = (function () {
            function UserController($scope, $rootScope, $http, $location, $window, $filter, $routeParams) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
            ...
            UserController.prototype.initTruck = function () {
                var _this = this;
                this.initEmployeeList();
                var truckId = this.$routeParams.employee_id;
                if (truckId) {
                    if (this.$location.path() === '/ql-toa-hang/xe/' + truckId) {
                        ...
                        if (this.currentTruck == null) {
                            this.truckService.getById(truckId, function (data) {
                                _this.currentTruck = data;
                                _this.currentTruck.startUsingDate = (data.startUsingDate != null && data.startUsingDate != null) ? new Date(data.startUsingDate) : null;
                                _this.currentTruck.buyingDate = (data.buyingDate != null && data.buyingDate != null) ? new Date(data.buyingDate) : null;
                                _this.currentTruck.checkDate = (data.checkDate != null && data.checkDate != null) ? new Date(data.checkDate) : null;
                                _this.currentTruck.insuranceDate = (data.insuranceDate != null && data.insuranceDate != null) ? new Date(data.insuranceDate) : null;
                                _this.monthlyPaymentFormated = data.monthlyPayment.toLocaleString();
                            }, null);
                        }
                    }
            ...
            UserController.prototype.initTruckList = function () {
                var _this = this;
                this.truckService.getAll(function (results) {
                    _this.truckList = results;
                    _this.truckList.sort(function (a, b) {
            ...
            UserController.prototype.initEmployeeList = function () {
                var _this = this;
                this.employeeService.getAll(function (results) {
                    _this.employeeList = results;
                }, null);
            ...
            UserController.prototype.getTruckListOnPage = function () {
                if (this.truckList && this.truckList.length > 0) {
                    var startIndex = this.pageSize * (this.currentPage - 1);
                    var endIndex = startIndex + this.pageSize;
                    return this.truckList.slice(startIndex, endIndex);
            ...
            UserController.prototype.selectAllTrucksOnPage = function () {
                var truckOnPage = this.getTruckListOnPage();
                for (var index = 0; index < truckOnPage.length; index++) {
                    var truck = truckOnPage[index];
                    truck.isChecked = this.isCheckedAll;
            ...
            UserController.prototype.removeTrucks = function () {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa xe?');
                if (confirmDialog) {
                    for (var i = 0; i < this.truckList.length; i++) {
            ...
            UserController.prototype.removeTruckInDetail = function (truck) {
                var _this = this;
                var confirmDialog = this.$window.confirm('Bạn có muốn xóa xe?');
                if (confirmDialog) {
                    this.truckService.deleteEntity(truck, function (data) {
            ...
            UserController.prototype.createTruck = function (truck) {
                var _this = this;
                this.truckService.create(truck, function (data) {
                    _this.$location.path('/ql-toa-hang/xe');
                }, function () { });
            };
            UserController.prototype.updateTruck = function (truck) {
                var _this = this;
                this.truckService.update(truck, function (data) {
                    _this.$location.path('/ql-toa-hang/xe');
                }, null);
            };
            UserController.prototype.goToTruckForm = function () {
                this.$location.path('/ql-toa-hang/xe/tao');
            };
            UserController.prototype.changeDateFormat = function (date) {
                var formatedDate = '';
                if (date) {
                    var newDate = new Date(date);
                    var dateNo = newDate.getDate().toString();
            ...
            UserController.prototype.checkStatusTruck = function (truck) {
                return truck.isDeleted ? 'Không' : 'Có';
            };
            UserController.prototype.getEmployeeName = function (id) {
                if (this.employeeList) {
                    for (var i = 0; i < this.employeeList.length; i++) {
                        var employee = this.employeeList[i];
                        if (employee.id == id) {
            ...
            UserController.prototype.setCurrencyFormat = function (changeFormatNumber) {
                if (changeFormatNumber && changeFormatNumber != '') {
                    this.currentTruck.monthlyPayment = parseInt(changeFormatNumber.replace(/,/g, ''));
                    this.monthlyPaymentFormated = this.currentTruck.monthlyPayment.toLocaleString();
                }
...
var ngDatepicker = ngDatepicker || angular.module('datepicker', []);

ngDatepicker.directive("datepicker", function () {
  return {
    restrict: "A",
    scope: {
      dateFormater: '=',
    ...
    require: 'ngModel',
    link: function (scope, element, attrs, ngModel) {
      scope.$watch('rangeDate', function (newValue, oldValue) {
        if (scope.rangeDate != null && scope.rangeDate[0] != null && scope.rangeDate[1] != null) {
          element.datepicker({
            dateFormat: scope.dateFormater,
            minDate: new Date(scope.rangeDate[0]),
            maxDate: new Date(scope.rangeDate[1]),

            //regional: "fr",
            onSelect: function (dateText) {
              scope.$apply(function () {
              	var date = new Date(dateText).getDate();
              	var month = new Date(dateText).getMonth() + 1;
              	var year = new Date(dateText).getFullYear();
              	var fulldate = month + '/' + date + '/' + year;
              	
              	ngModel.$setViewValue(fulldate);
              });
            }
          });
