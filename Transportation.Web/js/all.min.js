...
(function (Clarity) {
    ...
    (function (Helper) {
        var MainHelper = (function () {
            ...
            MainHelper.prototype.isUserHasGreaterOrEqualPermission = function (checkUserRole) {
...
(function (Clarity) {
    ...
    (function (Controller) {
        ...
        var UserController = (function () {
            function UserController($scope, $rootScope, $http, $location, $window, $filter, $routeParams, $cookieStore) {
                this.$scope = $scope;
                this.$rootScope = $rootScope;
                this.$http = $http;
                this.$location = $location;
                ...
                if (userId) {
                    if (this.$location.path() === '/ql-dang-nhap/' + userId) {
                        ...
                        if (this.currentUser == null) {
                            this.userService.getById(userId, function (data) {
                                _this.currentUser = data;
                                _this.currentUser.isEdited = true;
                            }, null);
                        }
                    }
                }
            ...
            UserController.prototype.checkStatusUser = function (user) {
                return user.isDeleted ? 'Không' : 'Có';
            };
            UserController.prototype.getRoleList = function () {
                var roleList = new Array();
                for (var i = 0; i < this.roles.length; i++) {
                    var role = new Clarity.Model.RoleModel();
                    role.id = i;
            ...
            UserController.prototype.getVNRoleName = function (name) {
